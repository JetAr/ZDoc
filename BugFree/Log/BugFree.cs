...
#region 05-23 19:23 R#.0    @Ver.Info
     ...
     Zndex_S : //z 2016-05-23 19:23:03 L.222'16617 T130859507 .K ~0   +----+----+----+----+----+
      L133,  1:R#.1    @
      L158,  2:znote astyle -A1 -R -Z -z1 -n *.cpp 
      L171,  3:znote stream 一些资源    
      L199,  4:todo rtmp 握手、建立连接、建立网络流，开始播放；寻找具体code验证下。
      L200,  5:todo 接收 v/a 部分的数据；具体如何解析出v/a数据的，也需了解。
      L201,  6:todo rtmpdump 中对数据的download部分。
      L431,  7:R#.2    @h264相关文章，h264分析以及解码
      L459,  8:R#.3    @看下使用 sdl 来播放 pcm 。
      L480,  9:R#.4    @tn todo 编译av ； av同步； 剥离实现
      L485, 10:todo 解析出rtmp的av数据，其中有dts数据，看看如何同步。
      L498, 11:R#.5    @atom 编辑器
      L504, 12:R#.6    @directshow audio capture filter
      L511, 13:R#.7    @SGK
      L512, 14:znote 36011
      L525, 15:R#.8    @sdl 实际的例子
      L555, 16:R#.9    @算法
      L561, 17:R#.10   @hevc
      L574, 18:R#.11   @png 载入
      L581, 19:R#.12   @设置 beyond compare 为diff tool
      L604, 20:R#.13   @iocp server
      L608, 21:zsummer/zsummerX
      L616, 22:R#.14   @ffmpeg
      L635, 23:R#.15   @JetZodiac
      L639, 24:R#.16   @glob 模式
      L645, 25:R#.17   @git用法
      L651, 26:R#.18   @电源管理 powercfg -hibernate
     Zndex_E : //z 2016-11-23 17:13:02 L.38 '24418 T1804223372.K ~259 +----+----+----+----+----+
     TimeCnt : //z 2016-08-03 18:36:20 L.150'19420 T2655646998.K ~27  +----+----+----+----+----+
     Reg.Cnt : //z 2016-08-03 18:36:19 L.150'19421 T2655646974.K ~18  +----+----+----+----+----+
     #18  R+ : //z 2016-08-03 18:36:19 L.150'19421 T2655646974.K ~18    V+.266  L+.647  
     ...
     File.Op : //z 2016-11-23 17:12:58 L.38 '24422 T1804187606.K ~2   +----+----+----+----+----+
     #2   O+ : //z 2016-11-23 17:12:58 L.38 '24422 T1804187606.K ~2     V+.277  L+.1    
     #1   O+ : //z 2016-07-20 22:58:14 L.164'3706  T1812878518.K ~1     V+.215  L+.1    
     Version : //z 2016-11-23 17:13:02 L.38 '24418 T1804223372.K ~277   R+.18   L+.668  --+----+
     #14  R+ : //z 2016-08-03 18:36:19 L.150'19421 T2655646974.K ~266   R+.18   L+.648  V+.266  
     ...
     K   Ver : //z 2016-08-03 18:36:10 L.150'19430 T2655646965.K ~263   R+.17   L+.643  
...
#region 08-03 18:36 R#.18   @电源管理 powercfg -hibernate
//z 2016-08-03 18:36:20 L.150'19420 T2655646998.K[T27,L647,R18,V267]
01. 
开始休眠方法：手工键入如下命令： 
...
因为原来启用了混合睡眠，所谓混合睡眠就是把待机和休眠合在了一起。如果你混合睡眠后电脑不断电，实质就是在待机；如果断电了，实质就是休眠。当你关闭混合睡眠后，那个睡眠按钮就是真正的待机，即仍然维持对内存供电；而连内存都断电的休眠模式就出来了。
#endregion //z 2016-08-03 18:36:19 L.150'19421 T2655646974.K.F4034662268---+----+----+----+----+
