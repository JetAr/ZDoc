...
void RenderDevice::SetDepthMode(bool enable, bool write, CompareFunc func)
{
    ...
    case Compare_Greater:
        dss.DepthFunc = D3D11_COMPARISON_GREATER;
        break;
    default:
        OVR_ASSERT(0);
    }
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            if (dsDesc.BindFlags & D3D11_BIND_SHADER_RESOURCE)
            {
                ...
                if (dsDesc.BindFlags & D3D11_BIND_DEPTH_STENCIL)
                {
                    ...
                    case DXGI_FORMAT_R16_TYPELESS:
                        depthSrv.Format = DXGI_FORMAT_R16_UNORM;
                        break;
            ...
            if (isDepth)
            {
                ...
                case Texture_Depth32f:
                    ...
                    break;
                case Texture_Depth24Stencil8:
                    depthDsv.Format = DXGI_FORMAT_D24_UNORM_S8_UINT;
                    break;
                case Texture_Depth16:
                    depthDsv.Format = DXGI_FORMAT_D16_UNORM;
                    break;
                case Texture_Depth32fStencil8:
                    depthDsv.Format = DXGI_FORMAT_D32_FLOAT_S8X24_UINT;
                    break;
