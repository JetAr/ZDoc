...
struct FunctionNotifyContext : public FunctionNotifyBase
{
    ...
    virtual void CallNotify(void* var)
    {
        (void)(pClass->*pFn)(static_cast<X*>(var));
    }
    virtual void CallNotify()
    {
        (void)(pClass->*pFn)(pContext);
    }
private:
...
struct OptionShortcut
{
    ...
    void AddShortcut(ShortcutKey key)
    {
        Keys.PushBack(key);
    }
    void AddShortcut(uint32_t gamepadButton)
    {
        GamepadButtons.PushBack(gamepadButton);
    }
...
public:
    ...
    virtual bool    SetValue(String newVal)
    {
        OVR_UNUSED1(newVal);
        return false;
    }
    virtual void    NextValue(bool* pFastStep = NULL)
    {
        OVR_UNUSED1(pFastStep);
    }
    virtual void    PrevValue(bool* pFastStep = NULL)
    {
        OVR_UNUSED1(pFastStep);
    }
...
public:
    ...
    int32_t* AsInt()
    {
        return reinterpret_cast<int32_t*>(pVar);
    }
    bool*    AsBool()
    {
        return reinterpret_cast<bool*>(pVar);
    }
    float*   AsFloat()
    {
        return reinterpret_cast<float*>(pVar);
    }
    VarType  GetType()
    {
        return Type;
