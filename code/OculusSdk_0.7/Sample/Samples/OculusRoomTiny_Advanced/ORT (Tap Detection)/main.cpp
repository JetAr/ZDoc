    ...
    while (basicVR.HandleMessages())
    {
        ...
        for (int eye = 0; eye < 2; eye++)
        {
            ...
            case(0) :
                ...
                break;
            case(1) :
                basicVR.Layer[0]->RenderSceneToEyeBuffer(&basicVR.MainCam, &basicVR.RoomScene,eye,0,0,1,1,1,0,0);
                break;
            case(2) :
                basicVR.Layer[0]->RenderSceneToEyeBuffer(&basicVR.MainCam, &basicVR.RoomScene,eye,0,0,1,1,0,1,0);
                break;
            case(3) :
                basicVR.Layer[0]->RenderSceneToEyeBuffer(&basicVR.MainCam, &basicVR.RoomScene,eye,0,0,1,1,0,0,1);
                break;
            }
        }
