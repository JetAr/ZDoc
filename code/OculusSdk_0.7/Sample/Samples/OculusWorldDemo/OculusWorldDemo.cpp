...
Sizei OculusWorldDemoApp::EnsureRendertargetAtLeastThisBig(int rtNum, Sizei requestedSize, ovrResult& error)
{
    ...
    {
    case DepthFormatOption_D32f:
        desiredDepthFormat = Texture_Depth32f;
        break;
    case DepthFormatOption_D24_S8:
        desiredDepthFormat = Texture_Depth24Stencil8;
        break;
    case DepthFormatOption_D16:
        desiredDepthFormat = Texture_Depth16;
        break;
    case DepthFormatOption_D32f_S8:
        desiredDepthFormat = Texture_Depth32fStencil8;
        break;
    default:
        OVR_ASSERT(false);
    }
...
void OculusWorldDemoApp::OnIdle()
{
    ...
    if ( LayersEnabled )
    {
        ...
        if ( Layer1Enabled && ( TextureOculusCube != NULL ) )
        {
            ...
            Layer1.ColorTexture     = TextureOculusCube->Get_ovrTextureSet();
            OVR_ASSERT(Layer1.ColorTexture);
        ...
        if ( Layer2Enabled && ( CockpitPanelTexture != NULL ) )
        {
            ...
            Layer2.ColorTexture  = CockpitPanelTexture->Get_ovrTextureSet();
            OVR_ASSERT(Layer2.ColorTexture);
        ...
        if ( Layer3Enabled && ( CockpitPanelTexture != NULL ) )
        {
            ...
            Layer3.ColorTexture     = CockpitPanelTexture->Get_ovrTextureSet();
            OVR_ASSERT(Layer3.ColorTexture);
        ...
        if ( ( LayerCockpitEnabled != 0 ) && ( CockpitPanelTexture != NULL ) )
        {
            for ( int cockpitLayer = 0; cockpitLayer < OVR_ARRAY_COUNT(CockpitLayer); cockpitLayer++ )
            {
                ...
                cl.ColorTexture  = CockpitPanelTexture->Get_ovrTextureSet();
                OVR_ASSERT(cl.ColorTexture);
