...
public:
    ...
    void HmdSettingChange(OptionVar* = 0)
    {
    ...
    void PerfHudSettingChange(OptionVar* = 0)
    {
        ovr_SetInt(Hmd, OVR_PERF_HUD_MODE, (int)PerfHudMode);
    }

    void DebugHudSettingModeChange(OptionVar* = 0)
    {
        ovr_SetInt(Hmd, OVR_DEBUG_HUD_STEREO_MODE, (int)DebugHudStereoMode);
    }
    void DebugHudSettingQuadPropChange(OptionVar* = 0);

    void BlockShowChange(OptionVar* = 0)
    {
        BlocksCenter = ThePlayer.BodyPos;
    }
