...
bool Player::HandleMoveKey(OVR::KeyCode key, bool down)
{
    ...
    case OVR::Key_Up:
        MoveForward = down ? (MoveForward | 2) : (MoveForward & ~2);
        return true;
    case OVR::Key_MouseWheelTowardUser:
    case OVR::Key_Down:
        MoveBack    = down ? (MoveBack    | 2) : (MoveBack    & ~2);
        return true;
    case OVR::Key_Left:
        MoveLeft    = down ? (MoveLeft    | 2) : (MoveLeft    & ~2);
        return true;
    case OVR::Key_Right:
        MoveRight   = down ? (MoveRight   | 2) : (MoveRight   & ~2);
        return true;
    default:
        return false;
    }
