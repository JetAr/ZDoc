...
private:
    array<System::Windows::Forms::Label^>^ drawLabel;
    //private: array<System::Windows::Forms::TextBox^>^ drawLabel;
private:
    array<System::Windows::Forms::TextBox^>^ arrLabel;
private:
    array<System::Windows::Forms::Label^>^ arrow;
private:
    System::Windows::Forms::Label^ head;
private:
    System::Windows::Forms::Label^ tail;
private:
    System::Windows::Forms::Label^ diff;
private:
    System::Windows::Forms::Label^ nullLabel;
...
private:
    System::Void label1_Enter(System::Object^  sender, System::EventArgs^  e);

private:
    System::Void label1_Leave(System::Object^  sender, System::EventArgs^  e);

private:
    System::Void tabPage1_Click(System::Object^  sender, System::Windows::Forms::TabControlEventArgs^  e);
