...
[dispinterface, uuid="ae17a339-6571-4302-8a84-6b27196f1e21"] __interface IEvent :
IDispatch
{
...
[object, library_block, uuid="8e46b2ec-a8b2-4b37-a75a-069c4336966d"] __interface IEvent2 :
IUnknown
{
    int event1([in]int);
