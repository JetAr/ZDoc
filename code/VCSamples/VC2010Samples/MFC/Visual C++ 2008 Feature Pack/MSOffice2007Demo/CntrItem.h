...
public:
    ...
    {
        return(CMSOffice2007DemoDoc*)CRichEditCntrItem::GetDocument();
    }
    CMSOffice2007DemoView* GetActiveView()
    {
        return(CMSOffice2007DemoView*)CRichEditCntrItem::GetActiveView();
    }
