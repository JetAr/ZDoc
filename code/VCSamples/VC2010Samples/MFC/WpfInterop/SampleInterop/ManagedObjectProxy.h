...
public:
    ...
    System::Object^ ThisObject() const
    {
        return static_cast<System::Object^>(m_handle);
    }
    System::Object^ operator->() const
    {
        return ThisObject();
    }
    System::Object^ operator*() const
    ...
    InteropDll_ImportExport operator bool() const
    {
        return !IsNull();
    }
    InteropDll_ImportExport bool operator!() const
    {
        return IsNull();
    }
