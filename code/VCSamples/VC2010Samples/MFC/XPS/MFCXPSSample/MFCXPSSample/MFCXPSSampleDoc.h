...
// Attributes
public:
    IXpsOMObjectFactory* 			GetXpsObjectFactory()
    {
        return m_pXpsObjectFactory;
    }
    IOpcFactory* 					GetOpcFactory()
    {
        return m_pOpcFactory;
    }
    IXpsOMPageReferenceCollection* 	GetPageRefColl()
    {
        return m_pFixedPageRefColl;
    }
...
public:
    ...
    const CString& GetTempFile() const
    {
