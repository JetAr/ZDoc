...
public:
    ...
    size_t GetLlamaCount() const
    {
        return(m_LlamaArr.GetCount());
    }
    size_t GetLeaderCount() const
    {
        return(m_LeaderArr.GetCount());
    }
...
public:
    ...
    int GetLlamaAcc() const
    {
        return(m_nLlamaAcc);
    }
    int GetLlamaVel() const
    {
        return(m_nLlamaVel);
    }
