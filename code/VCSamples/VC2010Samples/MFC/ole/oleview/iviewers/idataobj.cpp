    ...
    while (pIFormatEtc->Next( 1, &fetc, &ulFE ) == S_OK)
    {
        ...
        *pfetc = fetc ;
        ...
        case DVASPECT_CONTENT:
            _tcscat_s( sz, 512, _T( "CONTENT\t" ) ) ;
            break ;
        case DVASPECT_THUMBNAIL:
            _tcscat_s( sz, 512, _T( "THUMBNAIL\t" ) ) ;
            break ;
        case DVASPECT_ICON:
            _tcscat_s( sz, 512, _T( "ICON\t" ) ) ;
            break ;
        case DVASPECT_DOCPRINT:
            _tcscat_s( sz, 512, _T( "DOCPRINT\t" ) ) ;
            break ;
        default:
        ...
        {
        case TYMED_HGLOBAL:
            _tcscat_s( sz, 512, _T( "HGLOBAL\t" ) ) ;
            break ;
        case TYMED_FILE:
            _tcscat_s( sz, 512, _T( "FILE\t" ) ) ;
            break ;
        case TYMED_ISTREAM:
            _tcscat_s( sz, 512, _T( "ISTREAM\t" ) ) ;
            break ;
        case TYMED_ISTORAGE:
            _tcscat_s( sz, 512, _T( "ISTORAGE\t" ) ) ;
            break ;
        case TYMED_GDI:
            _tcscat_s( sz, 512, _T( "GDI\t" ) ) ;
            break ;
        case TYMED_MFPICT:
            _tcscat_s( sz, 512, _T( "MFPICT\t" ) ) ;
            break ;
        case TYMED_NULL:
            _tcscat_s( sz, 512, _T( "NULL\t" ) ) ;
            break ;
        default:
...
LPCTSTR MyGetClipboardFormatName( UINT cf )
{
    ...
    case CF_UNICODETEXT:
        _tcscpy_s( sz, 256, _T( "CF_UNICODETEXT" ) ) ;
        break ;
    case CF_ENHMETAFILE:
        _tcscpy_s( sz, 256, _T( "CF_ENHMETAFILE" ) ) ;
        break ;
    case CF_TEXT:
        _tcscpy_s( sz, 256, _T( "CF_TEXT" ) ) ;
        break ;
    case CF_BITMAP:
        _tcscpy_s( sz, 256, _T( "CF_BITMAP" ) ) ;
        break ;
    case CF_METAFILEPICT:
        _tcscpy_s( sz, 256, _T( "CF_METAFILEPICT" ) ) ;
        break ;
    case CF_SYLK:
        _tcscpy_s( sz, 256, _T( "CF_SYLK" ) ) ;
        break ;
    case CF_DIF:
        _tcscpy_s( sz, 256, _T( "CF_DIF" ) ) ;
        break ;
    case CF_TIFF:
        _tcscpy_s( sz, 256, _T( "CF_TIFF" ) ) ;
        break ;
    case CF_OEMTEXT:
        _tcscpy_s( sz, 256, _T( "CF_OEMTEXT" ) ) ;
        break ;
    case CF_DIB:
        _tcscpy_s( sz, 256, _T( "CF_DIB" ) ) ;
        break ;
    case CF_PALETTE:
        _tcscpy_s( sz, 256, _T( "CF_PALETTE" ) ) ;
        break ;
    case CF_PENDATA:
        _tcscpy_s( sz, 256, _T( "CF_PENDATA" ) ) ;
        break ;
    case CF_RIFF:
        _tcscpy_s( sz, 256, _T( "CF_RIFF" ) ) ;
        break ;
    case CF_WAVE:
        _tcscpy_s( sz, 256, _T( "CF_WAVE" ) ) ;
        break ;
    case 0:
        _tcscpy_s( sz, 256, _T( "\"Wildcard Advise\"" ) ) ;
        break ;
    default:
