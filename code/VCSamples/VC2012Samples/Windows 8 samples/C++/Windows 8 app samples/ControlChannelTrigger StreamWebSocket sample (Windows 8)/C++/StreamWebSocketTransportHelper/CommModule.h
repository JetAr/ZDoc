...
public:
    ...
    {
        ControlChannelTrigger^ get()
        {
            return channel_;
        }
        void set(ControlChannelTrigger^ value)
        {
            channel_ = value;
        }
    }
...
public:
    ...
    property StreamWebSocket^ SocketHandle
    {
        ...
        void set(StreamWebSocket^ value)
        {
            SocketHandle_ = value;
        }
    }
    ...
    property CommModule^ CommInstance
    {
        CommModule^ get()
        {
            return CommInstance_;
        }
        void set(CommModule^ value)
        {
            CommInstance_ = value;
        }
    }
