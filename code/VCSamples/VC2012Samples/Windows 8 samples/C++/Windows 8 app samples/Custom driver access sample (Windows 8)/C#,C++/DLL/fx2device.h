...
public:
    ...
    event SwitchStateChangedHandler^ SwitchStateChanged
    {
        ...
        void raise(__in Fx2Device^ Sender, __in SwitchStateChangedEventArgs^ args)
        {
            m_SwitchStateChangedEvent::raise(Sender, args);
        }
    };
};
...
public:
    ...
    property BYTE AsByte {BYTE get()
    {
        CheckResult();
        return m_State.SwitchesAsUChar;
    }};
    property Array<bool>^ SwitchState {Array<bool>^ get()
    {
        CheckResult();
...
public:
    ...
    property BYTE AsByte {BYTE get()
    {
        return m_State.BarsAsUChar;
    }};
    property Array<bool>^ BarGraphDisplay {Array<bool>^ get()
    {
        return m_Bars;
    }}

internal:
    ULONG_PTR* GetCancelToken(void)
    {
