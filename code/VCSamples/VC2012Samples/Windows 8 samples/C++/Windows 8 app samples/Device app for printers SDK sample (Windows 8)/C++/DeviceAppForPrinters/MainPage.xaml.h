...
public:
    ...
    {
        Windows::Devices::Printers::Extensions::PrintTaskConfiguration^ get()
        {
    ...
    {
        DeviceAppForPrinters::PrintHelper^ get()
        {
            return _printHelper;
        }
    }
    property Platform::Object^ PrinterExtensionContext
    {
        Platform::Object^ get()
        {
            return _printerExtensionContext;
        }
        void set(Platform::Object^ context)
        {
            SetContext(context);
        }
    }
