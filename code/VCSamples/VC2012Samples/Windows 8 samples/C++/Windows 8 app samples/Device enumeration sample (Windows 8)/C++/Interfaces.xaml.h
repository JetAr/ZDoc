...
public:
    ...
    property String^ IsEnabled { String^ get()
    {
        return isEnabled;
    }}
    property BitmapImage^ Thumbnail { BitmapImage^ get()
    {
        return thumbnail;
    }}
    property BitmapImage^ GlyphThumbnail { BitmapImage^ get()
    {
        return glyphThumbnail;
    }}
