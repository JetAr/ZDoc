...
public:
    ...
    virtual void _Enable(BOOL isEnable)
    {
        isEnable;
    };
    ...
    virtual BOOL _GetWindowRect(_Out_ LPRECT lpRect)
    {
        lpRect->bottom = 0;
        lpRect->left = 0;
        lpRect->right = 0;
    ...
    virtual BOOL _GetClientRect(_Out_ LPRECT lpRect)
    {
        lpRect->bottom = 0;
        lpRect->left = 0;
        lpRect->right = 0;
    ...
    virtual void _GetScrollInfo(_In_ CScrollInfo *lpsi)
    {
        lpsi;
    };
    ...
    virtual void _SetCurPos(int nPos, DWORD dwSB)
    {
        nPos;
        dwSB;
    };
