...
public:
    ...
    {
        return L"Service Components";
    }
    virtual UINT			GetObjectMenu()
    {
        return IDM_SERVICECOMPMENU;
    }
    virtual LONG			GetObjectImage()
    {
        return IMAGE_SERVICECOMP;
    }
    virtual REFIID			GetDefaultInterface()
    {
        return IID_IDataInitialize;
    }
...
public:
    ...
    virtual UINT			GetObjectMenu()
    {
        return IDM_DATALINKSMENU;
    }
    virtual LONG			GetObjectImage()
    {
        return IMAGE_DATALINKS;
    }
    virtual REFIID			GetDefaultInterface()
    {
        return IID_IDBPromptInitialize;
    }
    virtual	void			OnDefOperation();
