...
public: //@access public
    ...
    inline DBORDINAL GetColumnCnt()
    {
        return m_cColumns;
    };
    //@cmember Return the number of rows in the file
    inline DBCOUNTITEM GetRowCnt()
    {
        return m_cRows;
    };
    ...
    {
        return m_FileReadOnly;
    };
    //@cmember Return the columninfo array
    inline DBCOLUMNINFO * GetColInfo()
    {
        return m_rgdbcolinfo;
    };
    //@cmember Return the column name heap
    inline BYTE * GetColNameHeap()
    {
        return m_pbHeap;
    };
    //@cmember Return the column name heap size
    inline ULONG GetColNameHeapSize()
    {
        return m_cbHeapUsed;
    };
    //@cmember Return row data size for this file
    inline DBLENGTH GetRowSize()
    {
        return m_cbRowSize;
    };
