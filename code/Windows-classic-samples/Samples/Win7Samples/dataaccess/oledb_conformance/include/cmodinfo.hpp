...
public:
    ...
    inline virtual BOOL   IsUsingITableDefinition()
    {
        return m_fTableCreation;
    }
    inline virtual BOOL   UseIRowsetIndex(BOOL flag);
    inline virtual BOOL   IsUsingIRowsetIndex()
    {
        return m_fRowsetIndex;
    }

    inline virtual BOOL   IsStrictLeveling()
    {
        return m_fStrictConformance;
    }
    inline virtual ULONG  GetProviderLevel()
    {
        return m_dwProviderLevel;
    }
    inline virtual ULONG  SetInsert(ULONG dwInsert)
    {
        return m_dwInsert = dwInsert;
    }
    inline virtual ULONG  GetInsert()
    {
        return m_dwInsert;
    }
    inline virtual DWORD  PlugInServiceComponents(DWORD dwVal)
    {
        return m_dwServiceComponents = dwVal;
    }
    inline virtual DWORD  UseServiceComponents()
    {
        return m_dwServiceComponents;
    }
    inline virtual ULONG  GetWarningLevel()
    {
        return m_dwWarningLevel;
    }
    inline virtual DWORD  GetDebugMode()
    {
        return m_dwDebugMode;
    }

    inline virtual WCHAR* GetTableName()
    {
        return m_pwszTableName;
    }
    inline virtual DWORD  GetTableOpts()
    {
        return m_dwTableOpts;
    }

    inline virtual WCHAR* GetInitString()
    {
        return m_pwszInitString;
    }
    inline virtual WCHAR* GetFileName()
    {
        return m_pwszFileName;
    }
    inline virtual WCHAR* GetDefaultQuery()
    {
        return m_pwszDefaultQuery;
    }
    inline virtual WCHAR* GetRowScopedQuery()
    {
        return m_pwszRowScopedQuery;
    }
    inline virtual WCHAR* GetEnumerator()
    {
        return m_pwszEnumerator;
    }

    inline virtual void	  SetProviderCLSID(REFCLSID clsid)
    {
        m_clsidProvider = clsid;
    }
    inline virtual REFCLSID  GetProviderCLSID()
    {
        return m_clsidProvider;
    }
    inline virtual CLSCTX SetClassContext(CLSCTX ClsCtx)
    {
        return m_ClassContext = ClsCtx;
    }
    inline virtual CLSCTX GetClassContext()
    {
        return m_ClassContext;
    }
    inline virtual WCHAR* SetRemoteMachine(WCHAR* pwszRM)
    {
        return m_pwszRemoteMachine = pwszRM;
    }
    inline virtual WCHAR* GetRemoteMachine()
    {
        return m_pwszRemoteMachine;
    }
    inline virtual EQUERY GetRowsetQuery()
    {
        return m_eRowsetQuery;
    }

    inline virtual CThisTestModule* GetThisTestModule()
    {
        return m_pCThisTestModule;
    }
    inline virtual CError*			GetErrorObject()
    {
        return m_pCError;
    }
    inline virtual CParseInitFile*	GetParseObject()
    {
        return m_pCParseInitFile;
    }
    inline virtual CLocaleInfo*		GetLocaleInfo()
    {
        return m_pCLocaleInfo;
    }
    inline virtual CPoolManager*	GetPoolManager()
    {
        return m_pCPoolManager;
    }

    inline virtual BOOL   SetCompReadOnlyCols(BOOL flag)
    {
        return m_fCompareReadOnlyCols = flag;
    }
    inline virtual BOOL   GetCompReadOnlyCols()
    {
        return m_fCompareReadOnlyCols;
    }

    inline virtual WCHAR*			GetRootBinderProgID()
    {
        return m_pwszRootBinderProgID;
    }
    inline virtual WCHAR*			GetRootURL()
    {
        return m_pwszRootURL;
    }
    inline virtual IBindResource*	GetRootBinder()
    {
        return m_pIBindResource;
    }

    inline virtual BOOL   SetUseIntlIdentifier(BOOL flag)
    {
        return m_fUseIntlIdentifier = flag;
    }
    inline virtual BOOL   GetUseIntlIdentifier()
    {
        return m_fUseIntlIdentifier;
    }
    inline virtual BOOL   IsWin9x()
    {
        return m_fIsWin9x;
    }

    inline virtual const WCHAR* GetBackend()
    {
        return m_pwszBackend;
    }
    inline virtual BOOL InitBackendInfo(IDBInitialize *pIDBInitialize = NULL);
    inline virtual WCHAR* GetProviderVer()
    {
        return m_pwszProviderVer;
    }
...
public:
    ...
    //Interface
    virtual	BOOL		GetHooks()
    {
        return m_fHooks;
    }
    virtual	void		SetHooks(BOOL fHooks)
    {
        m_fHooks = fHooks;
    }
