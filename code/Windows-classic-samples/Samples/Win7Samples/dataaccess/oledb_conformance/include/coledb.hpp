...
public:
    ...
    IGetSession*		pIGetSession()
    {
        ASSERT(m_pIGetSession);
        return m_pIGetSession;
    }
    IConvertType*		pIConvertType()
    {
        ASSERT(m_pIConvertType);
        return m_pIConvertType;
    }
    IColumnsInfo*		pIColumnsInfo()
    {
        ASSERT(m_pIColumnsInfo);
        return m_pIColumnsInfo;
    }
    IDBCreateCommand*	pIDBCreateCommand()
    {
        return m_pIDBCreateCommand;
    }
