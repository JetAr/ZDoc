...
public:
    ...
    virtual ULONG		GetTotalRead()
    {
        return m_cbRead;
    }
    virtual ULONG		GetEndReached()
    {
        return m_cEndReached;
    }
    ...
    virtual void	SetS_OKonEOF(BOOL f)
    {
        m_fS_OKonEOF = f;
        return;
    }
    virtual void	SetQISeqStream(BOOL f)
    {
        m_fQISeqStream = f;
        return;
    }
    virtual void	SetQIStream(BOOL f)
    {
        m_fQIStream = f;
        return;
    }
    virtual void	SetQILockBytes(BOOL f)
    {
        m_fQILockBytes = f;
        return;
    }
