...
CLEANUP:
    ...
    inline BOOL	IsKnown(void)
    {
        return m_eProvider != UNKNOWN_PROVIDER && m_eDBMS != UNKNOWN_DBMS;
    }

    inline void SetBinding(DBBINDING * pBinding)
    {
        m_pDBBINDING = pBinding;
    }
    ...
    inline enum DBMS_ENUM GetDBMSType(void)
    {
        return m_eDBMS;
    }
