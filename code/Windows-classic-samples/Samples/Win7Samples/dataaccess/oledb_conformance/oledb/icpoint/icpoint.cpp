...
public:
    ...
    virtual int IsOptionalCP(REFIID riid)
    {
        return IID_IDBAsynchNotify==riid;
    };
...
public:
    ...
    virtual int IsOptionalCP(REFIID riid)
    {
        return IID_IRowsetNotify==riid || IID_IDBAsynchNotify==riid;
    };
...
public:
    ...
    virtual CSource*	pCSource(ULONG iSource)
    {
