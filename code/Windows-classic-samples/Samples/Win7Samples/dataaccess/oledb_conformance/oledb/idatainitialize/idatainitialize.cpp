...
public:
    ...
    inline	LONGLONG	GetFreq()
    {
        static LONGLONG sFreq = QueryFrequency();
        return sFreq;
    }
    inline	LONGLONG	GetDelta()
    {
        return m_lStop.QuadPart > m_lStart.QuadPart ? m_lStop.QuadPart - m_lStart.QuadPart : 0;
    }
    inline	double		GetSeconds()
    {
        return (double)GetDelta() / (double)GetFreq();
    }
...
public:
    ...
    LPCWSTR		GetInitString()
    {
        return m_cstrInitString;
    }
    double		GetSeconds()
    {
        return m_dSeconds;
    ...
    void		SetFileName(LPCWSTR pwszFileName)
    {
        m_cstrFileName	= pwszFileName;
    }
    void		SetInitString(LPCWSTR pwszInitString)
    {
        m_cstrInitString	= pwszInitString;
    }
    void		SetSeconds(double dSeconds)
    {
        m_dSeconds		= dSeconds;
    }
    void		SetAccessID(DWORD dwAccessID)
    {
        m_dwAccessID		= dwAccessID;
    }
    void		SetCached(BOOL fCached)
    {
        m_fCached			= fCached;
    }
