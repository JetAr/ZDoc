...
public:
    ...
    virtual ULONG						GetCountCP()
    {
        return m_cConnectionPoints;
    }
    virtual IConnectionPoint*			GetCP(ULONG iIndex = 0)
    {
        ASSERT(iIndex < m_cConnectionPoints);
        return m_rgConnectionPoints[iIndex];
    }
    virtual REFIID						GetIID()
    {
        return m_iid;
    }
    virtual EINTERFACE					GetObjectType()
    {
        return m_eObject;
    }
...
public:
    ...
    virtual BOOL	IsAsynch()
    {
        return (m_ulAsynch != 0);
    }

    //Helpers
    virtual DBCOUNTITEM	GetProgress()
    {
        return m_ulProgress;
    }
    virtual DBCOUNTITEM	GetProgressMax()
    {
        return m_ulProgressMax;
    }
    virtual ULONG	GetAsynchPhase()
    {
        return m_ulAsynchPhase;
    }
    virtual WCHAR*	GetStatusText()
    {
        return m_pwszStatusText;
    }

    virtual DBCOUNTITEM	GetPrevProgress()
    {
        return m_ulPrevProgress;
    }
    virtual DBCOUNTITEM	GetPrevProgressMax()
    {
        return m_ulPrevProgressMax;
    }
    virtual ULONG	GetPrevAsynchPhase()
    {
        return m_ulPrevAsynchPhase;
    }
    virtual WCHAR*	GetPrevStatusText()
    {
        return m_pwszPrevStatusText;
    }

    //Interface
    virtual IDBAsynchStatus*			const	pIDBAsynchStatus()
    {
        ASSERT(m_pIDBAsynchStatus);
        return m_pIDBAsynchStatus;
    }
...
public:
    ...
    //Indexing
    virtual CListener*		pCListener(ULONG iListener)
    {
        return m_vectListeners[iListener];
    }
    virtual CAsynch*		pCSource(ULONG iSource)
    {
        return m_vectSources[iSource];
    }
