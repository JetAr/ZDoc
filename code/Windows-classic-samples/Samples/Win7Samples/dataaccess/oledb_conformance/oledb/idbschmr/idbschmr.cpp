...
protected:
    ...
    virtual BOOL VerifyColumn(DBORDINAL iOrdinal, DATA * pColumn)
    {
        return TRUE;
    }
...
public:
    ...
    void UseArgumentDefaults(BOOL fUseDefaults)
    {
        m_fUseCommonArgumentDefaults = fUseDefaults;
    }
    GUID GetSchema(void)
    {
        return m_guidSchema;
    ...
    ULONG RestrictionCount(void)
    {
        return m_pSchemaInfo->cRestrictions;
    }
    void SetRestrictionArray(enum RESTRICT_ARRAY eRestrictArray)
    {
        m_eRestrictArray = eRestrictArray;
    }
    ...
    // Obsolete functions
    void SetRestrictions(ULONG ulRestrict)
    {
        m_restrict = ulRestrict;
    }
...
LPWSTR CHelper::CreateObject(UINT idsObject, LPWSTR pwszObjectName)
{
    return NULL;
}
BOOL CHelper::VerifyObject(UINT idsObject)
{
    return TRUE;
}
BOOL CHelper::VerifyObjectValue(UINT idsObject, ULONG iOrdinal)
{
    return TRUE;
}
...
public:
    ...
    CAssertionsHelper(void)
    {
        m_guidSchema = DBSCHEMA_ASSERTIONS;
    }
...
public:
    ...
    CCatalogsHelper(void)
    {
        m_guidSchema = DBSCHEMA_CATALOGS;
    }
};
...
public:
    ...
    CCharacterSetsHelper(void)
    {
        m_guidSchema = DBSCHEMA_CHARACTER_SETS;
    }
};
...
public:
    ...
    CCheckConstraintsHelper(void)
    {
        m_guidSchema = DBSCHEMA_CHECK_CONSTRAINTS;
    }
};
...
public:
    ...
    CCheckConstraintsByTableHelper(void)
    {
        m_guidSchema = DBSCHEMA_CHECK_CONSTRAINTS_BY_TABLE;
    }
...
public:
    ...
    CCollationsHelper(void)
    {
        m_guidSchema = DBSCHEMA_COLLATIONS;
    }
};
...
public:
    ...
    CColumnDomainUsageHelper(void)
    {
        m_guidSchema = DBSCHEMA_COLUMN_DOMAIN_USAGE;
    }
};
...
public:
    ...
    CColumnPrivilegesHelper(void)
    {
        m_guidSchema = DBSCHEMA_COLUMN_PRIVILEGES;
    }
};
...
public:
    ...
    CConstraintTableUsageHelper(void)
    {
        m_guidSchema = DBSCHEMA_CONSTRAINT_TABLE_USAGE;
    }
};
...
public:
    ...
    CConstraintColumnUsageHelper(void)
    {
        m_guidSchema = DBSCHEMA_CONSTRAINT_COLUMN_USAGE;
    }
};
...
public:
    ...
    CForeignKeysHelper(void)
    {
        m_guidSchema = DBSCHEMA_FOREIGN_KEYS;
    }
};
...
public:
    ...
    CKeyColumnUsageHelper(void)
    {
        m_guidSchema = DBSCHEMA_KEY_COLUMN_USAGE;
    }
};
...
public:
    ...
    CPrimaryKeysHelper(void)
    {
        m_guidSchema = DBSCHEMA_PRIMARY_KEYS;
    }
};
...
public:
    ...
    CProceduresHelper(void)
    {
        m_guidSchema = DBSCHEMA_PROCEDURES;
    }
    BOOL Init(CSchemaTest * pThis);
};
...
public:
    ...
    CProcedureColumnsHelper(void)
    {
        m_guidSchema = DBSCHEMA_PROCEDURE_COLUMNS;
    }
    BOOL Init(CSchemaTest * pThis);
};
...
public:
    ...
    CTableConstraintsHelper(void)
    {
        m_guidSchema = DBSCHEMA_TABLE_CONSTRAINTS;
    }
};
...
public:
    ...
    CTablePrivilegesHelper(void)
    {
        m_guidSchema = DBSCHEMA_TABLE_PRIVILEGES;
    }
};
...
public:
    ...
    CReferentialConstraintsHelper(void)
    {
        m_guidSchema = DBSCHEMA_REFERENTIAL_CONSTRAINTS;
    }
};
...
public:
    ...
    CSchemataHelper(void)
    {
        m_guidSchema = DBSCHEMA_SCHEMATA;
    }
};
...
public:
    ...
    CStatisticsHelper(void)
    {
        m_guidSchema = DBSCHEMA_STATISTICS;
    }
};
...
public:
    ...
    void SetHelper(CHelper * pCHelper)
    {
        m_pCHelper = pCHelper;
    }
