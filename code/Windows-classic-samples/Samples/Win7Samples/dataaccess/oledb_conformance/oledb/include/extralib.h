...
public:
    ...
    virtual DBCOUNTITEM   GetMaxOpenRows()
    {
        return m_ulMaxOpenRows;
    }
    virtual BOOL    AllowOpenRows(DBCOUNTITEM cOpenRows)
    {
        return m_ulMaxOpenRows==0 || m_ulMaxOpenRows>=cOpenRows;
    }
...
public:
    ...
    virtual DBCOUNTITEM   GetMaxPendingRows()
    {
        return m_ulMaxPendingRows;
    }
    virtual BOOL    AllowPendingRows(DBCOUNTITEM cPendingRows)
    {
        return m_ulMaxPendingRows==0 || m_ulMaxPendingRows>=cPendingRows;
    }
...
public:
    ...
    virtual BOOL	SetNotifications(BOOL bValue = TRUE)
    {
        m_bFire = bValue;
        return TRUE;
    }
    virtual BOOL	SetCancel(DBREASON eReason, DBEVENTPHASE ePhase)
    {
        m_eCancelReason = eReason;
        m_eCancelPhase = ePhase;
        return TRUE;
    }
    virtual BOOL	SetError(HRESULT hr)
    {
        m_hrReturn = hr;
        return TRUE;
    }
    virtual BOOL	SetType(REFIID riid = IID_IUnknown)
    {
        m_iid = riid;
        return TRUE;
    }
    ...
    virtual BOOL	SetAdvise(DBREASON eReason, DBEVENTPHASE ePhase)
    {
        m_eAdviseReason	= eReason;
        m_eAdvisePhase	= ePhase;
        return TRUE;
    }
    virtual BOOL	SetUnadvise(DBREASON eReason, DBEVENTPHASE ePhase)
    {
        m_eUnadviseReason = eReason;
        m_eUnadvisePhase = ePhase;
        return TRUE;
    }
