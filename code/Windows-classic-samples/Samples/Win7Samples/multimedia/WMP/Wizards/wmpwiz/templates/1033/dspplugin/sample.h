...
public:
    ...
    STDMETHOD( MFTAddInputStreams )( DWORD cStreams, DWORD* adwStreamIDs )
    {
        return E_NOTIMPL;
    }
    STDMETHOD( MFTDeleteInputStream )( DWORD dwStreamID )
    {
        return E_NOTIMPL;
    }
    STDMETHOD( GetAttributes )( IMFAttributes** pAttributes )
    {
        return E_NOTIMPL;
    }
    ...
    STDMETHOD( MFTGetOutputStatus )( DWORD* pdwFlags )
    {
        return E_NOTIMPL;
    }
    ...
    STDMETHOD( MFTProcessEvent )( DWORD  dwInputStreamID, IMFMediaEvent* pEvent )
    {
        return E_NOTIMPL;
    }
    ...
    STDMETHOD( MFTSetOutputBounds )( LONGLONG hnsLowerBound, LONGLONG hnsUpperBound )
    {
        return E_NOTIMPL;
    }
