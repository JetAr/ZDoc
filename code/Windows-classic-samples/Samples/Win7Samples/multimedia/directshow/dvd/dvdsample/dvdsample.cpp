...
CDVDLanguages::CDVDLanguages()
{
    ...
    m_lcidCodes[0] = 0x0407 ;
    m_apszLangNames[0] = TEXT("German\0") ;
    m_lcidCodes[1] = 0x0409 ;
    m_apszLangNames[1] = TEXT("English\0") ;
    m_lcidCodes[2] = 0x040a ;
    m_apszLangNames[2] = TEXT("Spanish\0") ;
    m_lcidCodes[3] = 0x040c ;
    m_apszLangNames[3] = TEXT("French\0") ;
    m_lcidCodes[4] = 0x0411 ;
    m_apszLangNames[4] = TEXT("Japanese\0") ;
    m_lcidCodes[5] = 0x0412 ;
    m_apszLangNames[5] = TEXT("Korean\0") ;
    m_lcidCodes[6] = 0x0413 ;
    m_apszLangNames[6] = TEXT("Dutch\0") ;
    m_lcidCodes[7] = 0x0816 ;
    m_apszLangNames[7] = TEXT("Portuguese\0") ;
    m_lcidCodes[8] = 0x041d ;
    m_apszLangNames[8] = TEXT("Swedish\0") ;
    m_lcidCodes[9] = 0x0804 ;
    m_apszLangNames[9] = TEXT("Chinese\0") ;
}
...
CParentLevels::CParentLevels()
{
    ...
    m_iCount = LEVELS ;
    m_alpszNames[0] = TEXT(" G \0") ;
    m_aiValues[0] = 1 ;
    m_alpszNames[1] = TEXT(" PG \0") ;
    m_aiValues[1] = 3 ;
    m_alpszNames[2] = TEXT(" PG-13 \0") ;
    m_aiValues[2] = 4 ;
    m_alpszNames[3] = TEXT(" R \0") ;
    m_aiValues[3] = 6 ;
    m_alpszNames[4] = TEXT(" NC-17 \0") ;
    m_aiValues[4] = 7 ;
    m_alpszNames[5] = TEXT(" Not Rated \0") ;
    m_aiValues[5] = 8 ;
}
