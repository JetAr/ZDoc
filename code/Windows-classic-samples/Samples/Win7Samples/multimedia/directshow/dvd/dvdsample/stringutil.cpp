...
const TCHAR* AsStr( DVD_TextStringType IDCD )
{
    ...
    case DVD_Struct_Volume:
        return TEXT("Struct_Volume\0");
    case DVD_Struct_Title:
        return TEXT("Struct_Title\0");
    case DVD_Struct_ParentalID:
        return TEXT("Struct_ParentalID\0");
    case DVD_Struct_PartOfTitle:
        return TEXT("Struct_Chapter\0");
    case DVD_Struct_Cell:
        return TEXT("Struct_Cell\0");
    case DVD_Stream_Audio:
        return TEXT("Stream_Audio\0");
    case DVD_Stream_Subpicture:
        return TEXT("Stream_Sub-picture\0");
    case DVD_Stream_Angle:
        return TEXT("Stream_Angle\0");
    case DVD_Channel_Audio:
        return TEXT("Audio Channel\0");
    case DVD_General_Name:
        return TEXT("General_name\0");
    case DVD_General_Comments:
        return TEXT("General_comments\0");
    case DVD_Title_Series:
        return TEXT("Title_Series\0");
    case DVD_Title_Movie:
        return TEXT("Title_Movie\0");
    case DVD_Title_Video:
        return TEXT("Title_Video\0");
    case DVD_Title_Album:
        return TEXT("Title_Album\0");
    case DVD_Title_Song:
        return TEXT("Title_Song\0");
    case DVD_Title_Other:
        return TEXT("Title_Other\0");
    case DVD_Title_Sub_Series:
        return TEXT("Title_Sub_Series\0");
    case DVD_Title_Sub_Movie:
        return TEXT("Title_Sub_Movie\0");
    case DVD_Title_Sub_Video:
        return TEXT("Title_Sub_Video\0");
    case DVD_Title_Sub_Album:
        return TEXT("Title_Sub_Album\0");
    case DVD_Title_Sub_Song:
        return TEXT("Title_Sub_Song\0");
    case DVD_Title_Sub_Other:
        return TEXT("Title_Sub_Other\0");
    case DVD_Title_Orig_Series:
        return TEXT("Title_Orig_Series\0");
    case DVD_Title_Orig_Movie:
        return TEXT("Title_Orig_Movie\0");
    case DVD_Title_Orig_Video:
        return TEXT("Title_Orig_Video\0");
    case DVD_Title_Orig_Album:
        return TEXT("Title_Orig_Album\0");
    case DVD_Title_Orig_Song:
        return TEXT("Title_Orig_Song\0");
    case DVD_Title_Orig_Other:
        return TEXT("Title_Orig_Other\0");
