                            ...
                            uint16_t dst_format, uint8_t dst_channels, int dst_rate)
    {
        ...
        if ( (src_rate/100) != (dst_rate/100) )
        {
            ...
            if ( src_rate > dst_rate )
            {
                ...
                {
                case 1:
                    rate_cvt = &audio_convert::RateDIV2;
                    break;
                case 2:
                    rate_cvt = &audio_convert::RateDIV2_c2;
                    break;
                case 4:
                    rate_cvt = &audio_convert::RateDIV2_c4;
                    break;
                case 6:
                    rate_cvt = &audio_convert::RateDIV2_c6;
                    break;
                default:
                    return false;
                }
            ...
            else
            {
                ...
                {
                case 1:
                    rate_cvt = &audio_convert::RateMUL2;
                    break;
                case 2:
                    rate_cvt = &audio_convert::RateMUL2_c2;
                    break;
                case 4:
                    rate_cvt = &audio_convert::RateMUL2_c4;
                    break;
                case 6:
                    rate_cvt = &audio_convert::RateMUL2_c6;
                    break;
                default:
                    return false;
                }
