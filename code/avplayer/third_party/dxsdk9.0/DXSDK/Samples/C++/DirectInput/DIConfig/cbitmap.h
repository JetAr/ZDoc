...
public:
    ...
    static CBitmap *CreateFromResource(HINSTANCE hInst, UINT uID)
    {
        return CreateFromResource(hInst, MAKEINTRESOURCE(uID));
    }
    ...
    static CBitmap *Create(int cx, int cy, HDC hDC = NULL)
    {
        SIZE size = {cx, cy};
        return Create(size, hDC);
    }
    ...
    BOOL Draw(HDC hDC, SIZE size)
    {
        return Draw(hDC, 0, 0, size);
    }
    BOOL Draw(HDC hDC, int x, int y, SIZE size)
    {
        POINT t = {x, y};
        return Draw(hDC, t, size);
    }
    ...
    BOOL Draw(HDC hDC, POINT origin)
    {
        SIZE t = {0, 0};
        return Draw(hDC, origin, t, TRUE);
    }
    BOOL Draw(HDC hDC, POINT origin, SIZE size, BOOL bAll = FALSE);

    BOOL Blend(HDC hDC)
    {
        return Blend(hDC, 0, 0);
    }
    BOOL Blend(HDC hDC, SIZE size)
    {
        return Blend(hDC, 0, 0, size);
    }
    BOOL Blend(HDC hDC, int x, int y, SIZE size)
    {
        POINT t = {x, y};
        return Blend(hDC, t, size);
    }
    BOOL Blend(HDC hDC, int x, int y)
    {
        POINT t = {x, y};
        return Blend(hDC, t);
    }
    BOOL Blend(HDC hDC, POINT origin)
    {
        SIZE t = {0, 0};
        return Blend(hDC, origin, t, TRUE);
    }
