...
public:
    ...
    void SetValues(int min, int max, int page)
    {
        SetRange(min, max, page);
    }
    ...
    {
        SetValues(min, max, page, GetPos());
    }
    void SetRange(int min, int max)
    {
        SetRange(min, max, GetPage());
    }

    void SetMin(int v)
    {
        SetValues(v, GetMax(), GetPage(), GetPos());
    }
    void SetMax(int v)
    {
        SetValues(GetMin(), v, GetPage(), GetPos());
    }
    void SetPage(int v)
    {
        SetValues(GetMin(), GetMax(), v, GetPos());
    }
    void SetPos(int v)
    {
        SetValues(GetMin(), GetMax(), GetPage(), v);
    }
    ...
    int GetThumbPos()
    {
        return m_bDragging ? m_nThumbPos : -1;
    }
