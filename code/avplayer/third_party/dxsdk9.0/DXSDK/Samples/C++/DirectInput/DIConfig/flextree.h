...
public:
    ...
    // root access
    operator CFTItem *() const
    {
        return m_pRoot;
    }
    CFTItem *GetRoot() const
    {
        return m_pRoot;
    }
...
public:
    ...
    // family access
    CFlexTree *GetTree() const
    {
        return m_pTree;
    }
    CFTItem *GetParent() const
    {
        return m_pParent;
    }
    CFTItem *GetPrevSibling() const
    {
        return m_pPrev;
    }
    CFTItem *GetNextSibling() const
    {
        return m_pNext;
    }
    CFTItem *GetFirstChild() const
    {
        return m_pFirst;
    }
    CFTItem *GetLastChild() const
    {
        return m_pLast;
    }
    ...
    BOOL IsUserGUID(const GUID &check) const
    {
        return IsEqualGUID(m_UserGUID, check);
    }
    void SetUserGUID(const GUID &set)
    {
        m_UserGUID = set;
    }
    const GUID &GetUserGUID() const
    {
        return m_UserGUID;
    }
...
protected:
    ...
    int GetChildIndent() const
    {
        return m_nChildIndent;
    }
...
protected:
    ...
    // finding
    virtual BOOL FoundItem(DWORD dwUser, void *pUser) const
    {
        return FALSE;
    }
