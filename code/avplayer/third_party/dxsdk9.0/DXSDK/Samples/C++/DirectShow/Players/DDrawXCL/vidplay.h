...
public:   // public methods for Windows structure to call
    ...
    inline  void    SetFileName(LPCTSTR lpszFileName)
    {
        lstrcpy(m_achFileName, lpszFileName) ;
    } ;
    inline  BOOL    IsGraphReady(void)
    {
        return (Uninitialized != m_eState) ;
    } ;
    inline  PLAYER_STATE GetState(void)
    {
        return m_eState ;
    } ;
    ...
    inline  LPCTSTR GetFileName(void)
    {
