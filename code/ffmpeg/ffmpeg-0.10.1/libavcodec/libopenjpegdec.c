...
static enum PixelFormat check_image_attributes(AVCodecContext *avctx, opj_image_t *image)
{
    ...
    {
    case 0111111:
        goto libopenjpeg_yuv444_rgb;
    case 0111212:
        return PIX_FMT_YUV440P;
    case 0112121:
        goto libopenjpeg_yuv422;
    case 0112222:
        goto libopenjpeg_yuv420;
    default:
        goto libopenjpeg_rgb;
    }
                                    ...
                                    AVPacket *avpkt)
{
    ...
    *data_size = 0;
    ...
    case 3:
        ...
        break;
    case 4:
        avctx->pix_fmt = is_yuva420(image) ? PIX_FMT_YUVA420P : PIX_FMT_RGBA;
        break;
    default:
