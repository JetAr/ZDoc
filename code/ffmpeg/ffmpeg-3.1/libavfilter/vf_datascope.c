...
static int filter_frame(AVFilterLink *inlink, AVFrame *in)
{
    ...
    td.in = in;
    td.out = out, td.yoff = xmaxlen, td.xoff = ymaxlen;
...
static int config_input(AVFilterLink *inlink)
{
    ...
    ff_draw_color(&s->draw, &s->white,  (uint8_t[])
    {
        255, 255, 255, 255
    } );
    ff_draw_color(&s->draw, &s->black,  (uint8_t[])
    {
        0, 0, 0, 0
    } );
    ff_draw_color(&s->draw, &s->yellow, (uint8_t[])
    {
        255, 255, 0, 255
    } );
    ff_draw_color(&s->draw, &s->gray,   (uint8_t[])
    {
        77, 77, 77, 255
    } );
    ...
    {
    case 0:
        s->filter = filter_mono;
        break;
    case 1:
        s->filter = filter_color;
        break;
    case 2:
        s->filter = filter_color2;
        break;
    }
