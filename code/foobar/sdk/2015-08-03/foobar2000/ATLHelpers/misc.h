...
public:
    ...
    {
        m_content.set(p_id,p_description);
    }
protected:
...
private:
    ...
    unsigned m_cmMgr_base, m_cmMgr_max;
};
...
template<typename _parentClass> class CWindowFixSEH : public _parentClass
{
public:
...
public:
    ...
    CWindowAutoLifetime(HWND parent) : TBase()
    {
        Init(parent);
    }
    template<typename TParam1> CWindowAutoLifetime(HWND parent, const TParam1 & p1) : TBase(p1)
    {
        Init(parent);
    }
    template<typename TParam1,typename TParam2> CWindowAutoLifetime(HWND parent, const TParam1 & p1,const TParam2 & p2) : TBase(p1,p2)
    {
        Init(parent);
    }
    template<typename TParam1,typename TParam2, typename TParam3> CWindowAutoLifetime(HWND parent, const TParam1 & p1,const TParam2 & p2,const TParam3 & p3) : TBase(p1,p2,p3)
    {
        Init(parent);
    }
    template<typename TParam1,typename TParam2, typename TParam3, typename TParam4> CWindowAutoLifetime(HWND parent, const TParam1 & p1,const TParam2 & p2,const TParam3 & p3,const TParam4 & p4) : TBase(p1,p2,p3,p4)
    {
        Init(parent);
    }
    template<typename TParam1,typename TParam2, typename TParam3, typename TParam4,typename TParam5> CWindowAutoLifetime(HWND parent, const TParam1 & p1,const TParam2 & p2,const TParam3 & p3,const TParam4 & p4, const TParam5 & p5) : TBase(p1,p2,p3,p4,p5)
    {
        Init(parent);
    }
    template<typename TParam1,typename TParam2, typename TParam3, typename TParam4,typename TParam5,typename TParam6> CWindowAutoLifetime(HWND parent, const TParam1 & p1,const TParam2 & p2,const TParam3 & p3,const TParam4 & p4, const TParam5 & p5, const TParam6 & p6) : TBase(p1,p2,p3,p4,p5,p6)
    {
        Init(parent);
    }
private:
    ...
    {
        PFC_ASSERT_NO_EXCEPTION( TBase::OnFinalMessage(wnd) );
...
static void ListView_FixContextMenuPoint(CListViewCtrl list,CPoint & coords)
{
    if (coords == CPoint(-1,-1))
    {
        int selWalk = -1;
        CRect rcClient;
        WIN32_OP_D(list.GetClientRect(rcClient));
        for(;;)
        {
