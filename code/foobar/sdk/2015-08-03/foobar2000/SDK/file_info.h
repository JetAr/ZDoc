...
struct replaygain_info
{
    ...
    inline bool format_album_gain(char p_buffer[text_buffer_size]) const
    {
        return g_format_gain(m_album_gain,p_buffer);
    }
    inline bool format_track_gain(char p_buffer[text_buffer_size]) const
    {
        return g_format_gain(m_track_gain,p_buffer);
    }
    inline bool format_album_peak(char p_buffer[text_buffer_size]) const
    {
        return g_format_peak(m_album_peak,p_buffer);
    }
    inline bool format_track_peak(char p_buffer[text_buffer_size]) const
    {
        return g_format_peak(m_track_peak,p_buffer);
    }
    ...
    inline bool set_from_meta(const char * p_name,const char * p_value)
    {
        return set_from_meta_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }

    inline bool is_album_gain_present() const
    {
        return m_album_gain != gain_invalid;
    }
    inline bool is_track_gain_present() const
    {
        return m_track_gain != gain_invalid;
    }
    inline bool is_album_peak_present() const
    {
        return m_album_peak != peak_invalid;
    }
    inline bool is_track_peak_present() const
    {
        return m_track_peak != peak_invalid;
    }

    inline void remove_album_gain()
    {
        m_album_gain = gain_invalid;
    }
    inline void remove_track_gain()
    {
        m_track_gain = gain_invalid;
    }
    inline void remove_album_peak()
    {
        m_album_peak = peak_invalid;
    }
    inline void remove_track_peak()
    {
...
public:
    ...
    {
        replaygain_info::g_format_gain(val, m_buffer);
    }
...
public:
    ...
    {
        replaygain_info::g_format_peak(val, m_buffer);
    }
...
inline bool operator==(const replaygain_info & item1,const replaygain_info & item2)
{
    return replaygain_info::g_equal(item1,item2);
}
inline bool operator!=(const replaygain_info & item1,const replaygain_info & item2)
{
    return !replaygain_info::g_equal(item1,item2);
...
public:
    ...
    inline t_size		meta_find(const char * p_name) const
    {
        return meta_find_ex(p_name,pfc_infinite);
    }
    inline bool			meta_exists(const char * p_name) const
    {
        return meta_exists_ex(p_name,pfc_infinite);
    }
    inline void			meta_remove_field(const char * p_name)
    {
        meta_remove_field_ex(p_name,pfc_infinite);
    }
    inline t_size		meta_set(const char * p_name,const char * p_value)
    {
        return meta_set_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
    inline void			meta_insert_value(t_size p_index,t_size p_value_index,const char * p_value)
    {
        meta_insert_value_ex(p_index,p_value_index,p_value,pfc_infinite);
    }
    inline void			meta_add_value(t_size p_index,const char * p_value)
    {
        meta_add_value_ex(p_index,p_value,pfc_infinite);
    }
    inline const char*	meta_get(const char * p_name,t_size p_index) const
    {
        return meta_get_ex(p_name,pfc_infinite,p_index);
    }
    inline t_size		meta_get_count_by_name(const char * p_name) const
    {
        return meta_get_count_by_name_ex(p_name,pfc_infinite);
    }
    inline t_size		meta_add(const char * p_name,const char * p_value)
    {
        return meta_add_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
    inline void			meta_modify_value(t_size p_index,t_size p_value_index,const char * p_value)
    {
        meta_modify_value_ex(p_index,p_value_index,p_value,pfc_infinite);
    }



    inline t_size		info_set(const char * p_name,const char * p_value)
    {
        return info_set_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
    inline t_size		info_find(const char * p_name) const
    {
        return info_find_ex(p_name,pfc_infinite);
    }
    inline bool			info_exists(const char * p_name) const
    {
        return info_exists_ex(p_name,pfc_infinite);
    }
    inline bool			info_remove(const char * p_name)
    {
        return info_remove_ex(p_name,pfc_infinite);
    }
    inline const char *	info_get(const char * p_name) const
    {
    ...
    inline bool			info_set_replaygain(const char * p_name,const char * p_value)
    {
    ...
    inline void			info_set_replaygain_auto(const char * p_name,const char * p_value)
    {
        info_set_replaygain_auto_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
    ...
    inline void	copy_meta_single_by_name(const file_info & p_source,const char * p_name)
    {
        copy_meta_single_by_name_ex(p_source,p_name,pfc_infinite);
    }
    inline void	copy_info_single_by_name(const file_info & p_source,const char * p_name)
    {
        copy_info_single_by_name_ex(p_source,p_name,pfc_infinite);
    }
    void		reset();
    ...
    inline void	copy_meta_single_rename(const file_info & p_source,t_size p_index,const char * p_new_name)
    {
        copy_meta_single_rename_ex(p_source,p_index,p_new_name,pfc_infinite);
    }
    ...
    inline t_int64 info_get_bitrate_vbr() const
    {
        return info_get_int("bitrate_dynamic");
    }
    inline void info_set_bitrate_vbr(t_int64 val)
    {
        info_set_int("bitrate_dynamic",val);
    }
    inline t_int64 info_get_bitrate() const
    {
        return info_get_int("bitrate");
    }
    inline void info_set_bitrate(t_int64 val)
    {
        info_set_int("bitrate",val);
    }
...
public:
    ...
    inline const file_info & operator=(const file_info & p_source)
    {
        copy(p_source);
        return *this;
    }
    ...
    {
        copy_meta_single_nocheck(p_source, p_index);
    }
    ...
    {
        return field_name_comparator::compare(n1, n2) == 0;
    }
...
protected:
    ...
    inline void	copy_meta_single_by_name_nocheck(const file_info & p_source,const char * p_name)
    {
        copy_meta_single_by_name_nocheck_ex(p_source,p_name,pfc_infinite);
    }
    inline void	copy_info_single_by_name_nocheck(const file_info & p_source,const char * p_name)
    {
        copy_info_single_by_name_nocheck_ex(p_source,p_name,pfc_infinite);
    }
    ...
    inline t_size	meta_set_nocheck(const char * p_name,const char * p_value)
    {
        return meta_set_nocheck_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
    inline t_size	info_set_nocheck(const char * p_name,const char * p_value)
    {
        return info_set_nocheck_ex(p_name,pfc_infinite,p_value,pfc_infinite);
    }
};
