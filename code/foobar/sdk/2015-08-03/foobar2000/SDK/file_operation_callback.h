...
public:
    ...
    {
        static_api_ptr_t<file_operation_callback_dynamic_manager>()->register_callback(this);
    }
    ~file_operation_callback_dynamic_impl_base()
    {
        static_api_ptr_t<file_operation_callback_dynamic_manager>()->unregister_callback(this);
    }
