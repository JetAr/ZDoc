...
public:
    ...
    inline bool is_redirect()
    {
        return (get_flags() & flag_redirect) != 0;
    }
    inline bool are_parallel_reads_slow()
    {
        return (get_flags() & flag_parallel_reads_slow) != 0;
    }
    ...
    {
        open_for_decoding(p_instance,p_filehint,p_path,p_abort);
    }
    ...
    {
        open_for_info_read(p_instance,p_filehint,p_path,p_abort);
    }
    ...
    {
        open_for_info_write(p_instance,p_filehint,p_path,p_abort);
    }
