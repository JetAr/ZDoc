...
public:
    ...
    void queue_flush()
    {
        queue_remove_mask(bit_array_true());
    }
    ...
    {
        return playlist_get_selected_count(get_active_playlist(),p_mask);
    }
