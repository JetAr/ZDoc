...
{
protected:
    ui_selection_callback_impl_base(bool activate = true) : m_active()
    {
        ui_selection_callback_activate(activate);
    }
...
protected:
    ...
    ui_selection_callback_impl_base_ex(bool activate = true) : m_active()
    {
        ui_selection_callback_activate(activate);
    }
