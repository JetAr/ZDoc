...
public:
    ...
    {
        if (p_subclass == get_subclass())
        {
            p_out = get_focus_priority();
            return true;
        }
        else
        {
...
public:
    ...
    {
        copy(p_instance->get_configuration());
    }
...
public:
    ...
    {
        return *reinterpret_cast<const TInstance*>(NULL);
    }
};
