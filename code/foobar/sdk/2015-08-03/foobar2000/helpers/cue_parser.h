...
public:
    ...
    {
        m_out.__info_add_unsafe(p_name,p_value);
    }
private:
    file_info & m_out;
};
...
public:
    ...
    template<typename t_callback> void enumerate_meta(t_callback & p_callback) const
    {
        m_meta.enumerate(p_callback);
    }
    template<typename t_callback> void enumerate_meta(t_callback & p_callback)
    {
        m_meta.enumerate(p_callback);
    }
...
public:
    ...
    {
        return m_impl.get_file_stats(p_abort);
    }
    ...
    inline static bool g_is_our_content_type(const char * p_content_type)
    {
        return t_base::g_is_our_content_type(p_content_type);
    }
    inline static bool g_is_our_path(const char * p_path,const char * p_extension)
    {
