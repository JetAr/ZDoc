...
public:
    ...
    audio_chunk::spec_t const & get_spec() const
    {
        return m_spec;
    }
private:
...
{
    service_ptr_t<file_decodedaudio> f;
    f = new service_impl_t < file_decodedaudio > ;
