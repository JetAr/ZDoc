...
public:
    ...
    bool is_ptr_owned(const void * p_item) const
    {
        return is_pointer_in_range(get_ptr(),get_size(),p_item);
    }
...
public:
    ...
    bool is_ptr_owned(const void * p_item) const
    {
        return is_pointer_in_range(m_buffer,m_size_total,p_item);
    }
...
public:
    ...
    bool is_ptr_owned(const void * p_item) const
    {
        return is_pointer_in_range(m_buffer,m_size,p_item);
    }
...
public:
    ...
    void set_size(t_size p_size)
    {
        m_content.set_size(p_size);
    }

    t_size get_size() const
    {
        return m_content.get_size();
    }
    ...
    void move_from(t_self & other)
    {
        m_content.move_from(other.m_content);
    }
private:
...
public:
    ...
    public:
        ...
        t_item * get_ptr()
        {
            return reinterpret_cast<t_item*>(&m_array);
        }
        const t_item * get_ptr() const
        {
            return reinterpret_cast<const t_item*>(&m_array);
        }
        ...
        bool is_ptr_owned(const void * p_item) const
        {
            return is_pointer_in_range(get_ptr(),p_width,p_item);
        }
        void prealloc(t_size) {}
        void force_reset()
        {
...
public:
    ...
    public:
        ...
        t_size get_size() const
        {
            return m_fixed.get_size() + m_variable.get_size();
        }
        bool is_ptr_owned(const void * p_item) const
        {
