...
public:
    ...
    inline static t_int32 rint32(audio_sample val)
    {
        return (t_int32)floor(val + 0.5);
    }
#endif


    static inline audio_sample gain_to_scale(double p_gain)
    {
        return (audio_sample)pow(10.0, p_gain / 20.0);
    }
    static inline double scale_to_gain(double scale)
    {
