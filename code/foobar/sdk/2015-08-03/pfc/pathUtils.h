...
template<typename t1, typename t2> inline bool equals(const t1 & v1, const t2 & v2)
{
    return comparator::compare(v1,v2) == 0;
}

template<typename t1, typename t2> inline int compare( t1 const & p1, t2 const & p2 )
{
