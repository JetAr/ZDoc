...
{
    p_string_length = strlen_max(p_string,p_string_length);
    p_tofind_length = strlen_max(p_tofind,p_tofind_length);
...
bool string_is_numeric(const char * p_string,t_size p_length) throw()
{
    ...
    {
        if (!char_is_numeric(p_string[walk]))
        {
            retval = false;
            break;
        }
