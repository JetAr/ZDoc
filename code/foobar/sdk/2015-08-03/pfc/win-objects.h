...
public:
    ...
    TItem * GetPtr() const
    {
        return reinterpret_cast<TItem*>(m_scope.GetPtr());
    }
    t_size GetSize() const
    {
...
public:
    ...
    HMENU detach()
    {
        return pfc::replace_t(m_menu,(HMENU)NULL);
    }
...
public:
    ...
    HANDLE detach()
    {
        return pfc::replace_t(m_handle,(HANDLE)NULL);
    }
    bool is_valid() const
    {
    ...
    {
        return g_wait_for(get(),p_timeout_seconds);
    }
...
public:
    ...
    HICON detach()
    {
        return pfc::replace_t(m_icon,(HICON)NULL);
    }
...
public:
    ...
    void Reset()
    {
        CoTaskMemFree(pfc::replace_null_t(m_ptr));
    }
    TPtr * Receive()
    {
        Reset();
