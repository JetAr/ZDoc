...
void Dfanalysis::DrawPic()
{
    ...
    case FF_QSCALE_TYPE_MPEG1:
        temp.Format(_T("MPEG1"));
        break;
    case FF_QSCALE_TYPE_MPEG2:
        temp.Format(_T("MPEG2"));
        break;
    case FF_QSCALE_TYPE_H264:
        temp.Format(_T("H.264"));
        break;
    case FF_QSCALE_TYPE_VP56:
        temp.Format(_T("VP5,VP6"));
        break;
    default:
        temp.Format(_T("Unknown"));
        break;
    }
    ...
    if(m_dfanalysisoutpicfolder.GetCheck()==TRUE)
    {
        ...
        {
        case DRAW_Q:
            pic_name.Format(_T("qp_%d.bmp"),frame_index);
            break;
        case DRAW_MB_TYPE:
            pic_name.Format(_T("mbtype_%d.bmp"),frame_index);
            break;
        case DRAW_MV0:
            pic_name.Format(_T("mv0_%d.bmp"),frame_index);
            break;
        case DRAW_MV1:
            pic_name.Format(_T("mv1_%d.bmp"),frame_index);
            break;
        case DRAW_REFINDEX0:
            pic_name.Format(_T("refindex_%d.bmp"),frame_index);
            break;
        case DRAW_REFINDEX1:
            pic_name.Format(_T("refindex_%d.bmp"),frame_index);
            break;
    ...
    if(m_dfanalysisoutdatafolder.GetCheck()==TRUE)
    {
        ...
        {
        case DRAW_Q:
            data_name.Format(_T("qp_%d.csv"),frame_index);
            break;
        case DRAW_MB_TYPE:
            data_name.Format(_T("mbtype_%d.csv"),frame_index);
            break;
        case DRAW_MV0:
            data_name.Format(_T("mv0_%d.csv"),frame_index);
            break;
        case DRAW_MV1:
            data_name.Format(_T("mv1_%d.csv"),frame_index);
            break;
        case DRAW_REFINDEX0:
            data_name.Format(_T("refindex_%d.csv"),frame_index);
            break;
        case DRAW_REFINDEX1:
            data_name.Format(_T("refindex_%d.csv"),frame_index);
            break;
