...
int ve_param_global(VideoState *is)
{
    ...
    if(video_stream!=-1)
    {
        ...
        {
        case 0:
            pix_fmt.Format(_T("YUV420P"));
            break;
        case 1:
            pix_fmt.Format(_T("YUYV422"));
            break;
        case 2:
            pix_fmt.Format(_T("RGB24"));
            break;
        case 3:
            pix_fmt.Format(_T("BGR24"));
            break;
        case 12:
            pix_fmt.Format(_T("PIX_FMT_YUVJ420P"));
            break;
        default:
...
int ve_param_vframe(VideoState *is,AVFrame *pFrame,AVPacket *packet)
{
    ...
    case 0:
        ...
        break;
    case 1:
        pict_type.Format(_T("I"));
        break;
    case 2:
        pict_type.Format(_T("P"));
        break;
    case 3:
        pict_type.Format(_T("B"));
        break;
    case 4:
        pict_type.Format(_T("S"));
        break;
    case 5:
        pict_type.Format(_T("SI"));
        break;
    case 6:
        pict_type.Format(_T("SP"));
        break;
    case 7:
        pict_type.Format(_T("BI"));
        break;
    default:
        pict_type.Format(_T("Unknown"));
    }
...
static void toggle_audio_display(VideoState *is,int mode)
{
    ...
    case SHOW_MODE_VIDEO:
        is->show_mode=(VideoState::ShowMode)SHOW_MODE_VIDEO;
        break;
    case SHOW_MODE_WAVES:
        is->show_mode=(VideoState::ShowMode)SHOW_MODE_WAVES;
        break;
    case SHOW_MODE_RDFT:
        is->show_mode=(VideoState::ShowMode)SHOW_MODE_RDFT;
        break;
    default:
        is->show_mode=(VideoState::ShowMode)SHOW_MODE_VIDEO;
        break;
