    ...
    *song_length = length;
    ...
    do
    {
        ...
        if (first_time && !frameInfo.error)
        {
            ...
            {
            case MAIN:
                tempstr.Format(_T("MAIN"));
                break;
            case LC:
                tempstr.Format(_T("LC"));
                break;
            case SSR:
                tempstr.Format(_T("SSR"));
                break;
            case LTP:
                tempstr.Format(_T("LTP"));
                break;
            case HE_AAC:
                tempstr.Format(_T("HE_AAC"));
                break;
            case ER_LC:
                tempstr.Format(_T("ER_LC"));
                break;
            case ER_LTP:
                tempstr.Format(_T("ER_LTP"));
                break;
            case LD:
                tempstr.Format(_T("LD"));
                break;
            case DRM_ER_LC:
                tempstr.Format(_T("DRM_ER_LC"));
                break;
            }
            ...
            {
            case RAW:
                tempstr.Format(_T("RAW"));
                break;
            case ADIF:
                tempstr.Format(_T("ADIF"));
                break;
            case ADTS:
                tempstr.Format(_T("ADTS"));
                break;
            case LATM:
                tempstr.Format(_T("LATM"));
                break;
            }
            ...
            {
            case NO_SBR:
                tempstr.Format(_T("off"));
                break;
            case SBR_UPSAMPLED:
                tempstr.Format(_T("on;upsample"));
                break;
            case SBR_DOWNSAMPLED:
                tempstr.Format(_T("on;downsampled"));
                break;
            case NO_SBR_UPSAMPLED:
                tempstr.Format(_T("off;upsampled"));
                break;
            }
