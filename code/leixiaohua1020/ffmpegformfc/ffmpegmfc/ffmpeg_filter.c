...
enum AVPixelFormat choose_pixel_fmt(AVStream *st, AVCodec *codec, enum AVPixelFormat target)
{
    if (codec && codec->pix_fmts)
    {
        ...
        if (st->codec->strict_std_compliance <= FF_COMPLIANCE_UNOFFICIAL)
        {
            ...
            {
                const enum AVPixelFormat pm[]= { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE };
                p = pm;
            ...
            else if (st->codec->codec_id == AV_CODEC_ID_LJPEG)
            {
                ...
                const enum AVPixelFormat pm[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUVJ444P, AV_PIX_FMT_YUV420P,
                                                  AV_PIX_FMT_YUV422P, AV_PIX_FMT_YUV444P, AV_PIX_FMT_BGRA, AV_PIX_FMT_NONE
                                                };
                p = pm;
            }
