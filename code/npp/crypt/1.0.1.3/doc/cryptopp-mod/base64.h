...
public:
    ...
    Base64Encoder(BufferedTransformation *attachment = NULL, bool insertLineBreaks = true, EOL eol = EOL::Unix, int maxLineLength = 72)
        : SimpleProxyFilter(new BaseN_Encoder(new Grouper), attachment)
    {
        IsolatedInitialize(MakeParameters(Name::InsertLineBreaks(), insertLineBreaks)(Name::MaxLineLength(), maxLineLength)("EOL", eol));
    }
