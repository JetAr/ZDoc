...
public:
    ...
    {
        throw NotImplemented("Clone() is not implemented yet.");   // TODO: make this =0
    }
};
...
public:
    ...
    bool GetThrowOnProtocolError() const
    {
        return m_throwOnProtocolError;
    }
    void SetThrowOnProtocolError(bool throwOnProtocolError)
    {
        m_throwOnProtocolError = throwOnProtocolError;
    }
