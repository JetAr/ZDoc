    ...
    case WM_COMMAND:
    {
        ...
        case IDC_OK:
        {
            if (_salt)
            {
                ...
                if (len <= 0)
                {
                    ::MessageBox(_hSelf, TEXT("Please enter a salt-value!"), TEXT("Error"), MB_OK);
                    break;
                    return FALSE;
                }
                else
            ...
            if (_iv)
            {
                ...
                if (len <= 0)
                {
                    ::MessageBox(_hSelf, TEXT("Please enter a iv-value!"), TEXT("Error"), MB_OK);
                    break;
                    return FALSE;
                }
                else
            ...
            if (_tag)
            {
                ...
                if (len <= 0)
                {
                    ::MessageBox(_hSelf, TEXT("Please enter a tag-value!"), TEXT("Error"), MB_OK);
                    break;
                    return FALSE;
                }
                else
