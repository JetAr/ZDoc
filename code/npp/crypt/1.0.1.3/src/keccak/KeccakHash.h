...
/**
  ...
  */
int Keccak_HashInitialize(Keccak_HashInstance *hashInstance, unsigned int rate, unsigned int capacity, unsigned int hashbitlen, unsigned char delimitedSuffix);
...
/**
  ...
  * @return SUCCESS if successful, FAIL otherwise.
  */
int Keccak_HashUpdate(Keccak_HashInstance *hashInstance, const BitSequence *data, DataLength databitlen);
 ...
 * @return SUCCESS if successful, FAIL otherwise.
 */
int Keccak_HashSqueeze(Keccak_HashInstance *hashInstance, BitSequence *data, DataLength databitlen);
