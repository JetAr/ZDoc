    ...
    , dontTouchConfig(false)
{
    ...
    else
    {
        ...
        //z outBufferSize = 10 * 1024 * 1024;
		outBufferSize = 32 * 1024 * 1024;
    }
...
void NVENCEncoder::init()
{
    ...
    if (!dontTouchConfig)
    {
        ...
        //z encodeConfig.encodeCodecConfig.h264Config.outputBufferingPeriodSEI = 1;
        //z encodeConfig.encodeCodecConfig.h264Config.outputPictureTimingSEI = 1;
        //z encodeConfig.encodeCodecConfig.h264Config.disableSPSPPS = 1;
		encodeConfig.encodeCodecConfig.h264Config.outputBufferingPeriodSEI = 0;
		encodeConfig.encodeCodecConfig.h264Config.outputPictureTimingSEI = 0;
        ...
        //z encodeConfig.encodeCodecConfig.h264Config.sliceMode = 3;
        //z encodeConfig.encodeCodecConfig.h264Config.sliceModeData = 1;
