...
{
	class ConnectionContextPool : public AbstractPool
	{
	public:
		ConnectionContextPool(void);
		~ConnectionContextPool(void);
	...
	extern ConnectionContextPool connectionContextPool;
}
