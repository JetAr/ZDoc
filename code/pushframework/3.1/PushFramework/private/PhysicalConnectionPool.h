...
{
	class PhysicalConnectionPool : public AbstractPool
	{
	public:
		PhysicalConnectionPool(void);
		~PhysicalConnectionPool(void);
	...
	extern PhysicalConnectionPool thePhysicalConnectionPool;
}
