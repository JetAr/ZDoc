...
void CNalParser::h264_debug_sps(sps_t* sps, HTREEITEM root)
{
    ...
    my_printf("profile_idc: %d  (8 bits)", sps->profile_idc );
    AddTreeItem(isps);
    my_printf_flag("constraint_set0_flag", sps->constraint_set0_flag );
    AddTreeItem(isps);
    my_printf_flag("constraint_set1_flag", sps->constraint_set1_flag );
    AddTreeItem(isps);
    my_printf_flag("constraint_set2_flag", sps->constraint_set2_flag );
    AddTreeItem(isps);
    my_printf_flag("constraint_set3_flag", sps->constraint_set3_flag );
    AddTreeItem(isps);
    my_printf_flag("constraint_set4_flag", sps->constraint_set4_flag );
    AddTreeItem(isps);
    my_printf_flag("constraint_set5_flag", sps->constraint_set5_flag );
    AddTreeItem(isps);
    my_printf("reserved_zero_2bits: %d  (2 bits)", sps->reserved_zero_2bits );
    AddTreeItem(isps);
    my_printf("level_idc: %d  (8 bits)", sps->level_idc );
    AddTreeItem(isps);
    my_printf("seq_parameter_set_id: %d  (v bits)", sps->seq_parameter_set_id );
    AddTreeItem(isps);
    if( sps->profile_idc == 100 || sps->profile_idc == 110 ||
            sps->profile_idc == 122 || sps->profile_idc == 144 )
    {
        my_printf("chroma_format_idc: %d  (8 bits)", sps->chroma_format_idc );
        AddTreeItem(isps);
        if (sps->chroma_format_idc == 3)
        {
            my_printf_flag("separate_colour_plane_flag", sps->separate_colour_plane_flag );
            AddTreeItem(isps);
        }
        my_printf("bit_depth_luma_minus8: %d  (v bits)", sps->bit_depth_luma_minus8 );
        AddTreeItem(isps);
        my_printf("bit_depth_chroma_minus8: %d  (v bits)", sps->bit_depth_chroma_minus8 );
        AddTreeItem(isps);
        my_printf_flag("qpprime_y_zero_transform_bypass_flag", sps->qpprime_y_zero_transform_bypass_flag );
        AddTreeItem(isps);
    ...
    my_printf("log2_max_frame_num_minus4: %d  (v bits)", sps->log2_max_frame_num_minus4 );
    AddTreeItem(isps);
    ...
    {
        my_printf_flag("delta_pic_order_always_zero_flag", sps->delta_pic_order_always_zero_flag );
        AddTreeItem(isps);
        my_printf("offset_for_non_ref_pic: %d  (v bits)", sps->offset_for_non_ref_pic );
        AddTreeItem(isps);
        my_printf("offset_for_top_to_bottom_field: %d  (v bits)", sps->offset_for_top_to_bottom_field );
        AddTreeItem(isps);
        my_printf("num_ref_frames_in_pic_order_cnt_cycle: %d  (v bits)", sps->num_ref_frames_in_pic_order_cnt_cycle );
        AddTreeItem(isps);
        for( int i = 0; i < sps->num_ref_frames_in_pic_order_cnt_cycle; i++ )
        {
            my_printf("offset_for_ref_frame[%d]: %d  (v bits)", i, sps->offset_for_ref_frame[i] );
            AddTreeItem(isps);
        }
    }
    my_printf("max_num_ref_frames: %d  (v bits)", sps->max_num_ref_frames );
    AddTreeItem(isps);
    my_printf_flag("gaps_in_frame_num_value_allowed_flag", sps->gaps_in_frame_num_value_allowed_flag );
    AddTreeItem(isps);
    my_printf("pic_width_in_mbs_minus1: %d  (v bits)", sps->pic_width_in_mbs_minus1 );
    AddTreeItem(isps);
    my_printf("pic_height_in_map_units_minus1: %d  (v bits)", sps->pic_height_in_map_units_minus1 );
    AddTreeItem(isps);
    my_printf_flag("frame_mbs_only_flag", sps->frame_mbs_only_flag );
    HTREEITEM fmof = AddTreeItem(isps);
    if( !sps->frame_mbs_only_flag )
    {
        my_printf_flag("mb_adaptive_frame_field_flag", sps->mb_adaptive_frame_field_flag );
        AddTreeItem(fmof);
    }
    my_printf_flag("direct_8x8_inference_flag", sps->direct_8x8_inference_flag );
    AddTreeItem(isps);
    my_printf_flag("frame_cropping_flag", sps->frame_cropping_flag );
    HTREEITEM fcf = AddTreeItem(isps);
    if (sps->frame_cropping_flag)
    {
        my_printf("frame_crop_left_offset: %d  (v bits)", sps->frame_crop_left_offset );
        AddTreeItem(fcf);
        my_printf("frame_crop_right_offset: %d  (v bits)", sps->frame_crop_right_offset );
        AddTreeItem(fcf);
        my_printf("frame_crop_top_offset: %d  (v bits)", sps->frame_crop_top_offset );
        AddTreeItem(fcf);
        my_printf("frame_crop_bottom_offset: %d  (v bits)", sps->frame_crop_bottom_offset );
        AddTreeItem(fcf);
    }
    ...
    if (sps->vui_parameters_present_flag)
    {
        ...
        {
            my_printf("aspect_ratio_idc: %d  (8 bits)", sps->vui.aspect_ratio_idc );
            AddTreeItem(aripf);
        ...
        {
            my_printf_flag("overscan_appropriate_flag", sps->vui.overscan_appropriate_flag );
            AddTreeItem(oipf);
        }
        ...
        {
            my_printf("video_format: %d  (3 bits)", sps->vui.video_format );
            AddTreeItem(vstpf);
            my_printf_flag("video_full_range_flag", sps->vui.video_full_range_flag );
            AddTreeItem(vstpf);
            ...
            {
                my_printf("colour_primaries: %d  (8 bits)", sps->vui.colour_primaries );
                AddTreeItem(cdpf);
                my_printf("transfer_characteristics: %d  (8 bits)", sps->vui.transfer_characteristics );
                AddTreeItem(cdpf);
                my_printf("matrix_coefficients: %d  (8 bits)", sps->vui.matrix_coefficients );
                AddTreeItem(cdpf);
            }
        }
        ...
        {
            my_printf("chroma_sample_loc_type_top_field: %d  (v bits)", sps->vui.chroma_sample_loc_type_top_field );
            AddTreeItem(clipf);
            my_printf("chroma_sample_loc_type_bottom_field: %d  (v bits)", sps->vui.chroma_sample_loc_type_bottom_field );
            AddTreeItem(clipf);
        }
        ...
        {
            my_printf("num_units_in_tick: %d  (32 bits)", sps->vui.num_units_in_tick );
            AddTreeItem(tipf);
            my_printf("time_scale: %d  (32 bits)", sps->vui.time_scale );
            AddTreeItem(tipf);
            my_printf_flag("fixed_frame_rate_flag", sps->vui.fixed_frame_rate_flag );
            AddTreeItem(tipf);
        }
        ...
        if( sps->vui.nal_hrd_parameters_present_flag )
        {
            ...
            my_printf("cpb_cnt_minus1: %d  (v bits)", sps->hrd.cpb_cnt_minus1 );
            AddTreeItem(hp);
            my_printf("bit_rate_scale: %d  (4 bits)", sps->hrd.bit_rate_scale );
            AddTreeItem(hp);
            my_printf("cpb_size_scale: %d  (4 bits)", sps->hrd.cpb_size_scale );
            AddTreeItem(hp);
            int SchedSelIdx;
            ...
            my_printf("initial_cpb_removal_delay_length_minus1: %d  (5 bits)", sps->hrd.initial_cpb_removal_delay_length_minus1 );
            AddTreeItem(nhppf);
            my_printf("cpb_removal_delay_length_minus1: %d  (5 bits)", sps->hrd.cpb_removal_delay_length_minus1 );
            AddTreeItem(nhppf);
            my_printf("dpb_output_delay_length_minus1: %d  (5 bits)", sps->hrd.dpb_output_delay_length_minus1 );
            AddTreeItem(nhppf);
            my_printf("time_offset_length: %d  (5 bits)", sps->hrd.time_offset_length );
            AddTreeItem(nhppf);
        }
        ...
        {
            my_printf_flag("low_delay_hrd_flag", sps->vui.low_delay_hrd_flag );
            AddTreeItem(vp); // tocheck
        }
        my_printf_flag("pic_struct_present_flag", sps->vui.pic_struct_present_flag );
        AddTreeItem(vp);
        my_printf_flag("bitstream_restriction_flag", sps->vui.bitstream_restriction_flag );
        HTREEITEM brf = AddTreeItem(vp);
        if( sps->vui.bitstream_restriction_flag )
        {
            my_printf_flag("motion_vectors_over_pic_boundaries_flag", sps->vui.motion_vectors_over_pic_boundaries_flag );
            AddTreeItem(brf);
            my_printf("max_bytes_per_pic_denom: %d  (v bits)", sps->vui.max_bytes_per_pic_denom );
            AddTreeItem(brf);
            my_printf("max_bits_per_mb_denom: %d  (v bits)", sps->vui.max_bits_per_mb_denom );
            AddTreeItem(brf);
            my_printf("log2_max_mv_length_horizontal: %d  (v bits)", sps->vui.log2_max_mv_length_horizontal );
            AddTreeItem(brf);
            my_printf("log2_max_mv_length_vertical: %d  (v bits)", sps->vui.log2_max_mv_length_vertical );
            AddTreeItem(brf);
            my_printf("num_reorder_frames: %d  (v bits)", sps->vui.num_reorder_frames );
            AddTreeItem(brf);
            my_printf("max_dec_frame_buffering: %d  (v bits)", sps->vui.max_dec_frame_buffering );
            AddTreeItem(brf);
        }
    }
}
...
void CNalParser::h264_debug_pps(pps_t* pps, HTREEITEM root)
{
    ...
    my_printf("pic_parameter_set_id: %d  (v bits)", pps->pic_parameter_set_id );
    AddTreeItem(ipps);
    my_printf("seq_parameter_set_id: %d  (v bits)", pps->seq_parameter_set_id );
    AddTreeItem(ipps);
    my_printf_flag("entropy_coding_mode_flag", pps->entropy_coding_mode_flag );
    AddTreeItem(ipps);
    my_printf_flag("bottom_field_pic_order_in_frame_present_flag", pps->bottom_field_pic_order_in_frame_present_flag);
    AddTreeItem(ipps);
    my_printf("num_slice_groups_minus1: %d  (v bits)", pps->num_slice_groups_minus1 );
    AddTreeItem(ipps);
    if( pps->num_slice_groups_minus1 > 0 )
    {
        my_printf("slice_group_map_type: %d  (v bits)", pps->slice_group_map_type );
        AddTreeItem(ipps);
    ...
    my_printf("num_ref_idx_l0_active_minus1: %d  (v bits)", pps->num_ref_idx_l0_active_minus1 );
    AddTreeItem(ipps);
    my_printf("num_ref_idx_l1_active_minus1: %d  (v bits)", pps->num_ref_idx_l1_active_minus1 );
    AddTreeItem(ipps);
    my_printf_flag("weighted_pred_flag", pps->weighted_pred_flag );
    AddTreeItem(ipps);
    ...
    my_printf("weighted_bipred_idc: %d  [%s]  (2 bits)", pps->weighted_bipred_idc, weighted_pre);
    AddTreeItem(ipps);
    my_printf("pic_init_qp_minus26: %d  (v bits)", pps->pic_init_qp_minus26 );
    AddTreeItem(ipps);
    my_printf("pic_init_qs_minus26: %d  (v bits)", pps->pic_init_qs_minus26 );
    AddTreeItem(ipps);
    my_printf("chroma_qp_index_offset: %d  (v bits)", pps->chroma_qp_index_offset );
    AddTreeItem(ipps);
    my_printf_flag("deblocking_filter_control_present_flag", pps->deblocking_filter_control_present_flag );
    AddTreeItem(ipps);
    my_printf_flag("constrained_intra_pred_flag", pps->constrained_intra_pred_flag );
    AddTreeItem(ipps);
    ...
    if( pps->_more_rbsp_data_present )
    {
        ...
        my_printf_flag("transform_8x8_mode_flag", pps->transform_8x8_mode_flag );
        AddTreeItem(imrdp);
        ...
        my_printf("second_chroma_qp_index_offset: %d  (v bits)", pps->second_chroma_qp_index_offset );
        AddTreeItem(imrdp);
    }
...
void CNalParser::h264_debug_slice_header(h264_stream_t* h, HTREEITEM root)
{
    ...
    my_printf("slice_type: %d (%s)  (v bits)", sh->slice_type, slice_type_name );
    AddTreeItem(iheader);
    ...
    {
        my_printf("colour_plane_id: %d  (2 bits)", sh->colour_plane_id );
        AddTreeItem(ppsid);
    }
    my_printf("frame_num: %d  (%d bits)", sh->frame_num, sh->frame_num_bytes );
    AddTreeItem(iheader);
    if( !sps->frame_mbs_only_flag )
    {
    ...
    {
        my_printf("idr_pic_id: %d  (v bits)", sh->idr_pic_id );
        AddTreeItem(iheader);
    }
    if( sps->pic_order_cnt_type == 0 )
    {
        my_printf("pic_order_cnt_lsb: %d  (%d bits)", sh->pic_order_cnt_lsb, sh->pic_order_cnt_lsb_bytes );
        AddTreeItem(iheader);
        if( pps->bottom_field_pic_order_in_frame_present_flag && !sh->field_pic_flag )
        {
            my_printf("delta_pic_order_cnt_bottom: %d  (v bits)", sh->delta_pic_order_cnt_bottom );
            AddTreeItem(iheader);
        }
    }
    ...
    {
        my_printf("delta_pic_order_cnt[0]: %d  (v bits)", sh->delta_pic_order_cnt[0] );
        AddTreeItem(iheader);
        if( pps->bottom_field_pic_order_in_frame_present_flag && !sh->field_pic_flag )
        {
    ...
    {
        my_printf("redundant_pic_cnt: %d  (v bits)", sh->redundant_pic_cnt );
        AddTreeItem(iheader);
    }
            ...
            ( pps->weighted_bipred_idc == 1 && is_slice_type( sh->slice_type, SH_SLICE_TYPE_B ) ) )
    {
        ...
        my_printf("luma_log2_weight_denom: %d  (v bits)", sh->pwt.luma_log2_weight_denom );
        AddTreeItem(ipwt);
...
void CNalParser::h264_debug_seis( h264_stream_t* h, HTREEITEM root)
{
    ...
    {
        sei_t* s = seis[i];
        my_printf("payloadType: %d  (v bits)", s->payloadType);
        AddTreeItem(iisei);
        my_printf("payloadSize: %d  (v bits)", s->payloadSize);
        AddTreeItem(iisei);
        ...
        case SEI_TYPE_DEC_REF_PIC_MARKING_REPETITION:
            my_printf("Dec ref pic marking repetition()");
            AddTreeItem(sp);
            break;
        ...
        case SEI_TYPE_SUB_SEQ_INFO:
            my_printf("Sub seq info()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_SUB_SEQ_LAYER_CHARACTERISTICS:
            my_printf("Sub seq layer characteristics()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_SUB_SEQ_CHARACTERISTICS:
            my_printf("Sub seq characteristics()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_FULL_FRAME_FREEZE:
            my_printf("Full frame freeze()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_FULL_FRAME_FREEZE_RELEASE:
            my_printf("Full frame freeze release()");
            AddTreeItem(sp);
            break;
        ...
        case SEI_TYPE_MOTION_CONSTRAINED_SLICE_GROUP_SET:
            my_printf("Motion constrained slice group set()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_FILM_GRAIN_CHARACTERISTICS:
            my_printf("film_grain_characteristics()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_DEBLOCKING_FILTER_DISPLAY_PREFERENCE:
            my_printf("Deblocking filter display preference()");
            AddTreeItem(sp);
            break;
        case SEI_TYPE_STEREO_VIDEO_INFO:
            my_printf("Stereo video info()");
            AddTreeItem(sp);
            break;
        default:
            my_printf("Unknown()");
...
void CNalParser::h264_debug_nal_t(h264_stream_t* h, nal_t* nal)
{
    ...
    my_printf("forbidden_zero_bit: %d (1 bit)", nal->forbidden_zero_bit );
    AddTreeItem(root);
    my_printf("nal_ref_idc: %d (2 bits)", nal->nal_ref_idc );
    AddTreeItem(root);
    ...
    {
        h264_debug_slice_header(h, root);
    }
...
void CNalParser::h265_debug_ptl(profile_tier_level_t* ptl, int profilePresentFlag, int max_sub_layers_minus1, HTREEITEM root)
{
    ...
    {
        my_printf("general_profile_space: %d  (2 bits)", ptl->general_profile_space);
        AddTreeItem(root);
        my_printf_flag("general_tier_flag", ptl->general_tier_flag);
        AddTreeItem(root);
        my_printf("general_profile_idc: %d  (5 bits)", ptl->general_profile_idc);
        AddTreeItem(root);
        for (int i = 0; i < 32; i++)
        {
            my_printf_flag2("general_profile_compatibility_flag", i, ptl->general_profile_compatibility_flag[i]);
            AddTreeItem(root);
        }
        my_printf_flag("general_progressive_source_flag", ptl->general_progressive_source_flag);
        AddTreeItem(root);
        my_printf_flag("general_interlaced_source_flag", ptl->general_interlaced_source_flag);
        AddTreeItem(root);
        my_printf_flag("general_non_packed_constraint_flag", ptl->general_non_packed_constraint_flag);
        AddTreeItem(root);
        my_printf_flag("general_frame_only_constraint_flag", ptl->general_frame_only_constraint_flag);
        AddTreeItem(root);
        ...
        {
            my_printf_flag("general_max_12bit_constraint_flag", ptl->general_max_12bit_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_max_10bit_constraint_flag", ptl->general_max_10bit_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_max_8bit_constraint_flag", ptl->general_max_8bit_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_max_422chroma_constraint_flag", ptl->general_max_422chroma_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_max_420chroma_constraint_flag", ptl->general_max_420chroma_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_max_monochrome_constraint_flag", ptl->general_max_monochrome_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_intra_constraint_flag", ptl->general_intra_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_one_picture_only_constraint_flag", ptl->general_one_picture_only_constraint_flag);
            AddTreeItem(root);
            my_printf_flag("general_lower_bit_rate_constraint_flag", ptl->general_lower_bit_rate_constraint_flag);
            AddTreeItem(root);
            my_printf("general_reserved_zero_34bits: %u  (34 bits)", ptl->general_reserved_zero_34bits);
            AddTreeItem(root); // tocheck
        }
        else
        {
            my_printf("general_reserved_zero_43bits: %u  (43 bits)", ptl->general_reserved_zero_43bits);
            AddTreeItem(root);// tocheck
        }
        ...
        {
            my_printf_flag("general_inbld_flag", ptl->general_inbld_flag);
            AddTreeItem(root);
        }
        else
        {
            my_printf("general_reserved_zero_bit: %d  (1 bit)", ptl->general_reserved_zero_bit);
            AddTreeItem(root);
        }
    }

    my_printf("general_level_idc: %d  (8 bits)", ptl->general_level_idc);
    AddTreeItem(root);
    for (int i = 0; i < max_sub_layers_minus1; i++)
    {
        my_printf_flag2("sub_layer_profile_present_flag", i, ptl->sub_layer_profile_present_flag[i]);
        AddTreeItem(root);
        my_printf_flag2("sub_layer_level_present_flag", i, ptl->sub_layer_level_present_flag[i]);
        AddTreeItem(root);
    }
    if (max_sub_layers_minus1 > 0)
    {
        ...
        {
            my_printf("reserved_zero_2bits[%d]: %d  (2 bits)", i, ptl->reserved_zero_2bits[i]);
            AddTreeItem(root);
        }
    }
    for (int i = 0; i < max_sub_layers_minus1; i++)
    {
        ...
        {
            my_printf("sub_layer_profile_space[%d]: %d  (2 bits)", i, ptl->sub_layer_profile_space[i]);
            AddTreeItem(root);
            my_printf_flag2("sub_layer_tier_flag", i, ptl->sub_layer_tier_flag[i]);
            AddTreeItem(root);
            my_printf("sub_layer_profile_idc[%d]: %d  (5 bits)", i, ptl->sub_layer_profile_idc[i]);
            AddTreeItem(root);
            for (int j = 0; j < 32; j++)
            {
            ...
            my_printf_flag2("sub_layer_progressive_source_flag", i, ptl->sub_layer_progressive_source_flag[i]);
            AddTreeItem(root);
            my_printf_flag2("sub_layer_interlaced_source_flag", i, ptl->sub_layer_interlaced_source_flag[i]);
            AddTreeItem(root);
            my_printf_flag2("sub_layer_non_packed_constraint_flag", i, ptl->sub_layer_non_packed_constraint_flag[i]);
            AddTreeItem(root);
            my_printf_flag2("sub_layer_frame_only_constraint_flag", i, ptl->sub_layer_frame_only_constraint_flag[i]);
            AddTreeItem(root);
            ...
            {
                my_printf_flag2("sub_layer_max_12bit_constraint_flag", i, ptl->sub_layer_max_12bit_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_max_10bit_constraint_flag", i, ptl->sub_layer_max_10bit_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_max_8bit_constraint_flag", i, ptl->sub_layer_max_8bit_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_max_422chroma_constraint_flag", i, ptl->sub_layer_max_422chroma_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_max_420chroma_constraint_flag", i, ptl->sub_layer_max_420chroma_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_max_monochrome_constraint_flag", i, ptl->sub_layer_max_monochrome_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_intra_constraint_flag", i, ptl->sub_layer_intra_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_one_picture_only_constraint_flag", i, ptl->sub_layer_one_picture_only_constraint_flag[i]);
                AddTreeItem(root);
                my_printf_flag2("sub_layer_lower_bit_rate_constraint_flag", i, ptl->sub_layer_lower_bit_rate_constraint_flag[i]);
                AddTreeItem(root);
                my_printf("sub_layer_reserved_zero_34bits[%d]: %ul  (34 bits)", i, ptl->sub_layer_reserved_zero_34bits[i]);
                AddTreeItem(root);
            }
            else
            {
                my_printf("sub_layer_reserved_zero_43bits: %ul  (43 bits)", ptl->sub_layer_reserved_zero_43bits);
                AddTreeItem(root);
            }
            // to check
            ...
            {
                my_printf_flag2("sub_layer_inbld_flag", i, ptl->sub_layer_inbld_flag[i]);
                AddTreeItem(root);
            }
            else
            {
                my_printf("sub_layer_reserved_zero_bit[%d]: %d  (1 bit)", i, ptl->sub_layer_reserved_zero_bit[i]);
                AddTreeItem(root);
            }
        }
        if (ptl->sub_layer_level_present_flag[i])
        {
            my_printf("sub_layer_level_idc[%d]: %d  (8 bits)", i, ptl->sub_layer_level_idc[i]);
            AddTreeItem(root);
        }
    }
}
...
void CNalParser::h265_debug_sub_layer_hrd_parameters(sub_layer_hrd_parameters_t* subhrd, int sub_pic_hrd_params_present_flag, int CpbCnt, int subLayerId, const char* p, HTREEITEM root)
{
    ...
    {
        my_printf("bit_rate_value_minus1[%d]: %d  (v bits)", i, subhrd->bit_rate_value_minus1[i]);
        AddTreeItem(slhp);
        my_printf("cpb_size_value_minus1[%d]: %d  (v bits)", i, subhrd->cpb_size_value_minus1[i]);
        AddTreeItem(slhp);
        if (sub_pic_hrd_params_present_flag)
        {
            my_printf("cpb_size_du_value_minus1[%d]: %d  (v bits)", i, subhrd->cpb_size_du_value_minus1[i]);
            AddTreeItem(slhp);
            my_printf("bit_rate_du_value_minus1[%d]: %d  (v bits)", i, subhrd->bit_rate_du_value_minus1[i]);
            AddTreeItem(slhp);
        }
        my_printf_flag2("cbr_flag", i, subhrd->cbr_flag[i]);
        AddTreeItem(slhp);
    }
}
void CNalParser::h265_debug_hrd_parameters(hrd_parameters_t* hrd, int commonInfPresentFlag, int maxNumSubLayersMinus1, HTREEITEM root)
{
    ...
    {
        my_printf_flag("nal_hrd_parameters_present_flag", hrd->nal_hrd_parameters_present_flag);
        AddTreeItem(ihrd);
        my_printf_flag("vcl_hrd_parameters_present_flag", hrd->vcl_hrd_parameters_present_flag);
        AddTreeItem(ihrd);
        if (hrd->nal_hrd_parameters_present_flag ||
                hrd->vcl_hrd_parameters_present_flag)
        {
            my_printf_flag("sub_pic_hrd_params_present_flag", hrd->sub_pic_hrd_params_present_flag);
            AddTreeItem(ihrd);
            if (hrd->sub_pic_hrd_params_present_flag)
            {
                my_printf("tick_divisor_minus2: %d  (8 bits)", hrd->tick_divisor_minus2);
                AddTreeItem(ihrd);
                my_printf("du_cpb_removal_delay_increment_length_minus1: %d  (8 bits)", hrd->du_cpb_removal_delay_increment_length_minus1);
                AddTreeItem(ihrd);
                my_printf_flag("sub_pic_cpb_params_in_pic_timing_sei_flag", hrd->sub_pic_cpb_params_in_pic_timing_sei_flag);
                AddTreeItem(ihrd);
                my_printf("dpb_output_delay_du_length_minus1: %d  (5 bits)", hrd->dpb_output_delay_du_length_minus1);
                AddTreeItem(ihrd);
            }
            my_printf("bit_rate_scale: %d  (4 bits)", hrd->bit_rate_scale);
            AddTreeItem(ihrd);
            my_printf("cpb_size_scale: %d  (4 bits)", hrd->cpb_size_scale);
            AddTreeItem(ihrd);
            if (hrd->sub_pic_hrd_params_present_flag)
                my_printf("cpb_size_du_scale: %d  (4 bits)", hrd->cpb_size_du_scale);
            AddTreeItem(ihrd);
            my_printf("initial_cpb_removal_delay_length_minus1: %d  (5 bits)", hrd->initial_cpb_removal_delay_length_minus1);
            AddTreeItem(ihrd);
            my_printf("au_cpb_removal_delay_length_minus1: %d  (5 bits)", hrd->au_cpb_removal_delay_length_minus1);
            AddTreeItem(ihrd);
            my_printf("dpb_output_delay_length_minus1: %d  (5 bits)", hrd->dpb_output_delay_length_minus1);
            AddTreeItem(ihrd);
        }
    }
    for (int i = 0; i <= maxNumSubLayersMinus1; i++)
    {
        my_printf_flag2("fixed_pic_rate_general_flag", i, hrd->fixed_pic_rate_general_flag[i]);
        AddTreeItem(ihrd);
        ...
        {
            my_printf("cpb_cnt_minus1[%d]: %d  (v bits)", i, hrd->cpb_cnt_minus1[i]);
            AddTreeItem(ihrd);
        }
...
void CNalParser::h265_debug_vps(h265_vps_t* vps, HTREEITEM root)
{
    ...
    my_printf("vps_video_parameter_set_id: %d  (4 bits)", vps->vps_video_parameter_set_id);
    AddTreeItem(ivps);
    my_printf_flag("vps_base_layer_internal_flag", vps->vps_base_layer_internal_flag);
    AddTreeItem(ivps);
    my_printf_flag("vps_base_layer_available_flag", vps->vps_base_layer_available_flag);
    AddTreeItem(ivps);
    my_printf("vps_max_layers_minus1: %d  (6 bits)", vps->vps_max_layers_minus1);
    AddTreeItem(ivps);
    my_printf("vps_max_sub_layers_minus1: %d  (3 bits)", vps->vps_max_sub_layers_minus1);
    AddTreeItem(ivps);
    my_printf_flag("vps_temporal_id_nesting_flag", vps->vps_temporal_id_nesting_flag);
    AddTreeItem(ivps);
    my_printf("vps_reserved_0xffff_16bits: %d  (16 bits)", vps->vps_reserved_0xffff_16bits);
    AddTreeItem(ivps);
    // ptl
    ...
    if (vps->vps_sub_layer_ordering_info_present_flag)
    {
        ...
        {
            my_printf("vps_max_dec_pic_buffering_minus1[%d]: %d  (v bits)", i, vps->vps_max_dec_pic_buffering_minus1[i]);
            AddTreeItem(isub);
            my_printf("vps_max_num_reorder_pics[%d]: %d  (v bits)", i, vps->vps_max_num_reorder_pics[i]);
            AddTreeItem(isub);
            my_printf("vps_max_latency_increase_plus1[%d]: %d  (v bits)", i, vps->vps_max_latency_increase_plus1[i]);
            AddTreeItem(isub);
        }
    }

    my_printf("vps_max_layer_id: %d  (6 bits)", vps->vps_max_layer_id);
    AddTreeItem(ivps);
    my_printf("vps_num_layer_sets_minus1: %d  (v bits)", vps->vps_num_layer_sets_minus1);
    AddTreeItem(ivps);
    for (i = 1; i <= vps->vps_num_layer_sets_minus1; i++)
    {
        for (j = 0; j <= vps->vps_max_layer_id; j++)
        {
            my_printf_flag3("layer_id_included_flag", i, j, vps->layer_id_included_flag[i][j]);
            AddTreeItem(ivps);
        }
    }
    ...
    {
        my_printf("vps_num_units_in_tick: %d  (32 bits)", vps->vps_num_units_in_tick);
        AddTreeItem(tipf);
        my_printf("vps_time_scale: %d  (32 bits)", vps->vps_time_scale);
        AddTreeItem(tipf);
        ...
        {
            my_printf("vps_num_ticks_poc_diff_one_minus1: %d  (v bits)", vps->vps_num_ticks_poc_diff_one_minus1);
            AddTreeItem(ppttf);
        }
        my_printf("vps_num_hrd_parameters: %d  (v bits)", vps->vps_num_hrd_parameters);
        AddTreeItem(tipf);
        for (i = 0; i < vps->vps_num_hrd_parameters; i++)
        {
            my_printf("hrd_layer_set_idx[%d]: %d  (v bits)", i, vps->hrd_layer_set_idx[i]);
            AddTreeItem(tipf);
            if (i > 0)
            {
                my_printf_flag2("cprms_present_flag", i, vps->cprms_present_flag[i]);
                AddTreeItem(tipf);
            }
            //  hrd_parameters()
    ...
    my_printf_flag("vps_extension_flag", vps->vps_extension_flag);
    AddTreeItem(ivps);
...
void CNalParser::h265_debug_short_term_ref_pic_set(h265_sps_t* sps, st_ref_pic_set_t*st, referencePictureSets_t* rps, int stRpsIdx, HTREEITEM root)
{
    ...
    {
        my_printf("delta_idx_minus1: %d (v bits)", st->delta_idx_minus1);
        AddTreeItem(srpsii);
        my_printf("delta_rps_sign: %d (1 bit)", st->delta_rps_sign);
        AddTreeItem(srpsii);
        my_printf("abs_delta_rps_minus1: %d (v bits)", st->abs_delta_rps_minus1);
        AddTreeItem(srpsii);
        ...
        {
            my_printf_flag2("used_by_curr_pic_flag", j, st->used_by_curr_pic_flag[j]);
            AddTreeItem(srpsii);
            if (!st->used_by_curr_pic_flag[j])
            {
                my_printf_flag2("use_delta_flag", j, st->use_delta_flag[j]);
                AddTreeItem(srpsii);
            }
        }
    }
    ...
    {
        my_printf("num_negative_pics: %d (v bits)", st->num_negative_pics);
        AddTreeItem(srpsii);
        my_printf("num_positive_pics: %d (v bits)", st->num_positive_pics);
        AddTreeItem(srpsii);
        for (int i = 0; i < st->num_negative_pics; i++)
        {
            my_printf("delta_poc_s0_minus1[%d]: %d  (v bits)", i, st->delta_poc_s0_minus1[i]);
            AddTreeItem(srpsii);
            my_printf_flag2("used_by_curr_pic_s0_flag", i, st->used_by_curr_pic_s0_flag[i]);
            AddTreeItem(srpsii);
        }
        for (int i = 0; i < st->num_positive_pics; i++)
        {
            my_printf("delta_poc_s1_minus1[%d]: %d (v bits)", i, st->delta_poc_s1_minus1[i]);
            AddTreeItem(srpsii);
            my_printf_flag2("used_by_curr_pic_s1_flag", i, st->used_by_curr_pic_s1_flag[i]);
            AddTreeItem(srpsii);
        }
    }
}
void CNalParser::h265_debug_vui_parameters(vui_parameters_t* vui, int maxNumSubLayersMinus1, HTREEITEM root)
{
    ...
    {
        my_printf("aspect_ratio_idc: %d  (8 bits)", vui->aspect_ratio_idc);
        AddTreeItem(aripf);
        if (vui->aspect_ratio_idc == H265_SAR_Extended)
        {
            my_printf("sar_width: %d   (16 bits)", vui->sar_width);
            AddTreeItem(aripf);
            my_printf("sar_height: %d  (16 bits)", vui->sar_height);
            AddTreeItem(aripf);
        }
    }
    ...
    {
        my_printf_flag("overscan_appropriate_flag", vui->overscan_appropriate_flag);
        AddTreeItem(oipf);
    }
    ...
    {
        my_printf("video_format: %d  (3 bits)", vui->video_format);
        AddTreeItem(vstpf);
        my_printf_flag("video_full_range_flag", vui->video_full_range_flag);
        AddTreeItem(vstpf);
        my_printf_flag("colour_description_present_flag", vui->colour_description_present_flag);
        HTREEITEM cdpf = AddTreeItem(vstpf);
        if (vui->colour_description_present_flag)
        {
            my_printf("colour_primaries: %d  (8 bits)", vui->colour_primaries);
            AddTreeItem(cdpf);
            my_printf("transfer_characteristics: %d  (8 bits)", vui->transfer_characteristics);
            AddTreeItem(cdpf);
            my_printf("matrix_coeffs: %d  (8 bits)", vui->matrix_coeffs);
            AddTreeItem(cdpf);
        }
    }
    ...
    my_printf_flag("neutral_chroma_indication_flag", vui->neutral_chroma_indication_flag);
    AddTreeItem(ivp);
    my_printf_flag("field_seq_flag", vui->field_seq_flag);
    AddTreeItem(ivp);
    my_printf_flag("frame_field_info_present_flag", vui->frame_field_info_present_flag);
    AddTreeItem(ivp);
    my_printf_flag("default_display_window_flag", vui->default_display_window_flag);
    HTREEITEM ddwf = AddTreeItem(ivp);
    if (vui->default_display_window_flag)
    {
        my_printf("def_disp_win_left_offset: %d  (v bits)", vui->def_disp_win_left_offset);
        AddTreeItem(ddwf);
        my_printf("def_disp_win_right_offset: %d  (v bits)", vui->def_disp_win_right_offset);
        AddTreeItem(ddwf);
        my_printf("def_disp_win_top_offset: %d  (v bits)", vui->def_disp_win_top_offset);
        AddTreeItem(ddwf);
        my_printf("def_disp_win_bottom_offset: %d  (v bits)", vui->def_disp_win_bottom_offset);
        AddTreeItem(ddwf);
    }
    ...
    {
        my_printf("vui_num_units_in_tick: %d  (32 bits)", vui->vui_num_units_in_tick);
        AddTreeItem(vtipf);
        my_printf("vui_time_scale: %d  (32 bits)", vui->vui_time_scale);
        AddTreeItem(vtipf);
    ...
    {
        my_printf_flag("tiles_fixed_structure_flag", vui->tiles_fixed_structure_flag);
        AddTreeItem(brf);
        my_printf_flag("motion_vectors_over_pic_boundaries_flag", vui->motion_vectors_over_pic_boundaries_flag);
        AddTreeItem(brf);
        my_printf_flag("restricted_ref_pic_lists_flag", vui->restricted_ref_pic_lists_flag);
        AddTreeItem(brf);
        my_printf("min_spatial_segmentation_idc: %d  (v bits)", vui->min_spatial_segmentation_idc);
        AddTreeItem(brf);
        my_printf("max_bytes_per_pic_denom: %d  (v bits)", vui->max_bytes_per_pic_denom);
        AddTreeItem(brf);
        my_printf("max_bits_per_min_cu_denom: %d  (v bits)", vui->max_bits_per_min_cu_denom);
        AddTreeItem(brf);
        my_printf("log2_max_mv_length_horizontal: %d  (v bits)", vui->log2_max_mv_length_horizontal);
        AddTreeItem(brf);
        my_printf("log2_max_mv_length_vertical: %d  (v bits)", vui->bitstream_restriction_flag);
        AddTreeItem(brf);
    }
}
// sps
void CNalParser::h265_debug_sps(h265_sps_t* sps, HTREEITEM root)
{
    ...
    HTREEITEM isps = AddTreeItem(root);
    my_printf("sps_video_parameter_set_id: %d  (4 bits)", sps->sps_video_parameter_set_id);
    AddTreeItem(isps);
    my_printf("sps_max_sub_layers_minus1: %d  (4 bits)", sps->sps_max_sub_layers_minus1);
    AddTreeItem(isps);
    my_printf_flag("sps_temporal_id_nesting_flag", sps->sps_temporal_id_nesting_flag);
    AddTreeItem(isps);
    // ptl
    my_printf("profile_tier_level()");
    ...
    my_printf("sps_seq_parameter_set_id: %d  (v bits)", sps->sps_seq_parameter_set_id);
    AddTreeItem(isps);
    my_printf("chroma_format_idc: %d  (v bits)", sps->chroma_format_idc);
    AddTreeItem(isps);
    if (sps->chroma_format_idc == 3)
    {
        my_printf_flag("separate_colour_plane_flag", sps->separate_colour_plane_flag);
    ...
    my_printf("pic_width_in_luma_samples: %d  (v bits)", sps->pic_width_in_luma_samples);
    AddTreeItem(isps);
    my_printf("pic_height_in_luma_samples: %d  (v bits)", sps->pic_height_in_luma_samples);
    AddTreeItem(isps);
    my_printf_flag("conformance_window_flag", sps->conformance_window_flag);
    HTREEITEM cwf = AddTreeItem(isps);
    if (sps->conformance_window_flag)
    {
        my_printf("conf_win_left_offset: %d  (v bits)", sps->conf_win_left_offset);
        AddTreeItem(cwf);
        my_printf("conf_win_right_offset: %d  (v bits)", sps->conf_win_right_offset);
        AddTreeItem(cwf);
        my_printf("conf_win_top_offset: %d  (v bits)", sps->conf_win_top_offset);
        AddTreeItem(cwf);
        my_printf("conf_win_bottom_offset: %d  (v bits)", sps->conf_win_bottom_offset);
        AddTreeItem(cwf);
    }
    my_printf("bit_depth_luma_minus8: %d  (v bits)", sps->bit_depth_luma_minus8);
    AddTreeItem(isps);
    ...
    {
        my_printf("sps_max_dec_pic_buffering_minus1[%d]: %d  (v bits)", i, sps->sps_max_dec_pic_buffering_minus1[i]);
        AddTreeItem(isloripf);
        my_printf("sps_max_num_reorder_pics[%d]: %d  (v bits)", i, sps->sps_max_num_reorder_pics[i]);
        AddTreeItem(isloripf);
        my_printf("sps_max_latency_increase_plus1[%d]: %d  (v bits)", i, sps->sps_max_latency_increase_plus1[i]);
        AddTreeItem(isloripf);
    }
    my_printf("log2_min_luma_coding_block_size_minus3: %d  (v bits)", sps->log2_min_luma_coding_block_size_minus3);
    AddTreeItem(isps);
    my_printf("log2_diff_max_min_luma_coding_block_size: %d  (v bits)", sps->log2_diff_max_min_luma_coding_block_size);
    AddTreeItem(isps);
    my_printf("log2_min_luma_transform_block_size_minus2: %d  (v bits)", sps->log2_min_luma_transform_block_size_minus2);
    AddTreeItem(isps);
    my_printf("log2_diff_max_min_luma_transform_block_size: %d  (v bits)", sps->log2_diff_max_min_luma_transform_block_size);
    AddTreeItem(isps);
    my_printf("max_transform_hierarchy_depth_inter: %d  (v bits)", sps->max_transform_hierarchy_depth_inter);
    AddTreeItem(isps);
    my_printf("max_transform_hierarchy_depth_intra: %d  (v bits)", sps->max_transform_hierarchy_depth_intra);
    AddTreeItem(isps);
    ...
    my_printf_flag("amp_enabled_flag", sps->amp_enabled_flag);
    AddTreeItem(isps);
    my_printf_flag("sample_adaptive_offset_enabled_flag", sps->sample_adaptive_offset_enabled_flag);
    AddTreeItem(isps);
    my_printf_flag("pcm_enabled_flag", sps->pcm_enabled_flag);
    HTREEITEM pef = AddTreeItem(isps);
    if (sps->pcm_enabled_flag)
    {
        my_printf("pcm_sample_bit_depth_luma_minus1: %d  (4 bits)", sps->pcm_sample_bit_depth_luma_minus1);
        AddTreeItem(pef);
        my_printf("pcm_sample_bit_depth_chroma_minus1: %d  (4 bits)", sps->pcm_sample_bit_depth_chroma_minus1);
        AddTreeItem(pef);
        my_printf("log2_min_pcm_luma_coding_block_size_minus3: %d  (v bits)", sps->log2_min_pcm_luma_coding_block_size_minus3);
        AddTreeItem(pef);
        my_printf("log2_diff_max_min_pcm_luma_coding_block_size: %d  (v bits)", sps->log2_diff_max_min_pcm_luma_coding_block_size);
        AddTreeItem(pef);
        my_printf_flag("pcm_loop_filter_disabled_flag", sps->pcm_loop_filter_disabled_flag);
        AddTreeItem(pef);
    }
    ...
    my_printf_flag("sps_temporal_mvp_enabled_flag", sps->sps_temporal_mvp_enabled_flag);
    AddTreeItem(isps);
    my_printf_flag("strong_intra_smoothing_enabled_flag", sps->strong_intra_smoothing_enabled_flag);
    AddTreeItem(isps);
    my_printf_flag("vui_parameters_present_flag", sps->vui_parameters_present_flag);
    HTREEITEM vppf = AddTreeItem(isps);
    if (sps->vui_parameters_present_flag)
    ...
    if (sps->sps_extension_present_flag)
    {
        ...
        {
            my_printf_flag("transform_skip_rotation_enabled_flag", sps->sps_range_extension.transform_skip_rotation_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("transform_skip_context_enabled_flag", sps->sps_range_extension.transform_skip_context_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("implicit_rdpcm_enabled_flag", sps->sps_range_extension.implicit_rdpcm_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("explicit_rdpcm_enabled_flag", sps->sps_range_extension.explicit_rdpcm_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("extended_precision_processing_flag", sps->sps_range_extension.extended_precision_processing_flag);
            AddTreeItem(sref);
            my_printf_flag("intra_smoothing_disabled_flag", sps->sps_range_extension.intra_smoothing_disabled_flag);
            AddTreeItem(sref);
            my_printf_flag("high_precision_offsets_enabled_flag", sps->sps_range_extension.high_precision_offsets_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("persistent_rice_adaptation_enabled_flag", sps->sps_range_extension.persistent_rice_adaptation_enabled_flag);
            AddTreeItem(sref);
            my_printf_flag("cabac_bypass_alignment_enabled_flag", sps->sps_range_extension.cabac_bypass_alignment_enabled_flag);
            AddTreeItem(sref);
        }
        ...
        my_printf_flag("sps_3d_extension_flag", sps->sps_3d_extension_flag);
        AddTreeItem(sepf);
        my_printf("sps_extension_5bits: %d  (5 bits)", sps->sps_extension_5bits);
        AddTreeItem(sepf);
    }
...
void CNalParser::h265_debug_pps(h265_pps_t* pps, HTREEITEM root)
{
    my_printf("pic_parameter_set_rbsp()");
    HTREEITEM ipps = AddTreeItem(root);
    my_printf("pps_pic_parameter_set_id: %d  (v bits)", pps->pps_pic_parameter_set_id);
    AddTreeItem(ipps);
    my_printf("pps_seq_parameter_set_id: %d  (v bits)", pps->pps_seq_parameter_set_id);
    AddTreeItem(ipps);
    my_printf_flag("dependent_slice_segments_enabled_flag", pps->dependent_slice_segments_enabled_flag);
    AddTreeItem(ipps);
    my_printf_flag("output_flag_present_flag", pps->output_flag_present_flag);
    AddTreeItem(ipps);
    my_printf("num_extra_slice_header_bits: %d  (3 bits)", pps->num_extra_slice_header_bits);
    AddTreeItem(ipps);
    my_printf_flag("sign_data_hiding_enabled_flag", pps->sign_data_hiding_enabled_flag);
    AddTreeItem(ipps);
    my_printf_flag("cabac_init_present_flag", pps->cabac_init_present_flag);
    AddTreeItem(ipps);
    my_printf("num_ref_idx_l0_default_active_minus1: %d  (v bits)", pps->num_ref_idx_l0_default_active_minus1);
    AddTreeItem(ipps);
    my_printf("num_ref_idx_l1_default_active_minus1: %d  (v bits)", pps->num_ref_idx_l1_default_active_minus1);
    AddTreeItem(ipps);
    my_printf("init_qp_minus26: %d  (v bits)", pps->init_qp_minus26);
    AddTreeItem(ipps);
    my_printf_flag("constrained_intra_pred_flag", pps->constrained_intra_pred_flag);
    AddTreeItem(ipps);
    my_printf_flag("transform_skip_enabled_flag", pps->transform_skip_enabled_flag);
    AddTreeItem(ipps);
    ...
    my_printf("pps_cb_qp_offset: %d  (v bits)", pps->pps_cb_qp_offset);
    AddTreeItem(ipps);
    my_printf("pps_cr_qp_offset: %d  (v bits)", pps->pps_cr_qp_offset);
    AddTreeItem(ipps);
    my_printf_flag("pps_slice_chroma_qp_offsets_present_flag", pps->pps_slice_chroma_qp_offsets_present_flag);
    AddTreeItem(ipps);
    my_printf_flag("weighted_pred_flag", pps->weighted_pred_flag);
    AddTreeItem(ipps);
    my_printf_flag("weighted_bipred_flag", pps->weighted_bipred_flag);
    AddTreeItem(ipps);
    my_printf_flag("transquant_bypass_enabled_flag", pps->transquant_bypass_enabled_flag);
    AddTreeItem(ipps);
    my_printf_flag("tiles_enabled_flag", pps->tiles_enabled_flag);
    HTREEITEM tef = AddTreeItem(ipps);
    if (pps->tiles_enabled_flag)
    {
        my_printf("num_tile_columns_minus1: %d  (v bits)", pps->num_tile_columns_minus1);
        AddTreeItem(tef);
        my_printf("num_tile_rows_minus1: %d  (v bits)", pps->num_tile_rows_minus1);
        AddTreeItem(tef);
        ...
        if (!pps->uniform_spacing_flag)
        {
            ...
            {
                my_printf("column_width_minus1[%d]: %d  (v bits)", i, pps->column_width_minus1[i]);
                AddTreeItem(usf);
            }
            for (int i = 0; i < pps->num_tile_rows_minus1; i++)
            {
                my_printf("row_height_minus1[%d]: %d  (v bits)", i, pps->row_height_minus1[i]);
                AddTreeItem(usf);
            }
        }
    ...
    my_printf_flag("entropy_coding_sync_enabled_flag", pps->entropy_coding_sync_enabled_flag);
    AddTreeItem(ipps);
    ...
    if (pps->deblocking_filter_control_present_flag)
    {
        ...
        {
            my_printf("pps_beta_offset_div2: %d  (v bits)", pps->pps_beta_offset_div2);
            AddTreeItem(dfdf);
            my_printf("pps_tc_offset_div2: %d  (v bits)", pps->pps_tc_offset_div2);
            AddTreeItem(dfdf);
        }
    }
    ...
    my_printf_flag("lists_modification_present_flag", pps->lists_modification_present_flag);
    AddTreeItem(ipps);
    my_printf("log2_parallel_merge_level_minus2: %d  (v bits)", pps->log2_parallel_merge_level_minus2);
    AddTreeItem(ipps);
    my_printf_flag("slice_segment_header_extension_present_flag", pps->slice_segment_header_extension_present_flag);
    AddTreeItem(ipps);
    my_printf_flag("pps_extension_present_flag", pps->pps_extension_present_flag);
    HTREEITEM epf = AddTreeItem(ipps);
    if (pps->pps_extension_present_flag)
    {
        my_printf_flag("pps_range_extension_flag", pps->pps_range_extension_flag);
        AddTreeItem(epf);
        ...
        if (pps->pps_range_extension_flag)
        {
            ...
            my_printf_flag("cross_component_prediction_enabled_flag", pps->pps_range_extension.cross_component_prediction_enabled_flag);
            AddTreeItem(iref);
            my_printf_flag("chroma_qp_offset_list_enabled_flag", pps->pps_range_extension.chroma_qp_offset_list_enabled_flag);
            AddTreeItem(iref);
            if (pps->pps_range_extension.chroma_qp_offset_list_enabled_flag)
            {
                my_printf("diff_cu_chroma_qp_offset_depth: %d  (v bits)", pps->pps_range_extension.diff_cu_chroma_qp_offset_depth);
                AddTreeItem(iref);
                my_printf("chroma_qp_offset_list_len_minus1: %d  (v bits)", pps->pps_range_extension.chroma_qp_offset_list_len_minus1);
                AddTreeItem(iref);
                for (int i = 0; i < pps->pps_range_extension.chroma_qp_offset_list_len_minus1; i++)
                {
                    my_printf("cb_qp_offset_list[%d]: %d  (v bits)", i, pps->pps_range_extension.cb_qp_offset_list[i]);
                    AddTreeItem(iref);
                    my_printf("cr_qp_offset_list[%d]: %d  (v bits)", i, pps->pps_range_extension.cb_qp_offset_list[i]);
                    AddTreeItem(iref);
                }
            }
            my_printf("log2_sao_offset_scale_luma: %d  (v bits)", pps->pps_range_extension.log2_sao_offset_scale_luma);
            AddTreeItem(iref);
            my_printf("log2_sao_offset_scale_chroma: %d  (v bits)", pps->pps_range_extension.log2_sao_offset_scale_chroma);
            AddTreeItem(iref);
        }
        my_printf_flag("pps_multilayer_extension_flag", pps->pps_multilayer_extension_flag);
        AddTreeItem(epf);
        my_printf_flag("pps_3d_extension_flag", pps->pps_3d_extension_flag);
        AddTreeItem(epf);
        my_printf("pps_extension_5bits: %d  (5 bits)", pps->pps_extension_5bits);
        AddTreeItem(epf);
    }
...
void CNalParser::h265_debug_pred_weight_table(h265_stream_t* h, HTREEITEM root)
{
    ...
    my_printf("luma_log2_weight_denom: %d  (v bits)", pwt->luma_log2_weight_denom);
    AddTreeItem(ipwt);
    ...
    for (int i = 0; i <= h->sh->num_ref_idx_l0_active_minus1; i++)
    {
        ...
        {
            my_printf("delta_luma_weight_l0[%d]: %d  (v bits)", i, pwt->delta_luma_weight_l0[i]);
            AddTreeItem(nria);
            my_printf("luma_offset_l0[%d]: %d  (v bits)", i, pwt->luma_offset_l0[i]);
            AddTreeItem(nria);
        }
        if (pwt->chroma_weight_l0_flag[i])
        {
            for (int j = 0; j < 2; j++)
            {
                my_printf("delta_chroma_weight_l0[%d][%d]: %d  (v bits)", i, j, pwt->delta_chroma_weight_l0[i][j]);
                AddTreeItem(nria);
                my_printf("delta_chroma_offset_l0[%d][%d]: %d  (v bits)", i, j, pwt->delta_chroma_offset_l0[i][j]);
                AddTreeItem(nria);
            }
        }
    }
    ...
    if (h->sh->slice_type == H265_SH_SLICE_TYPE_B)
    {
        ...
        for (int i = 0; i <= h->sh->num_ref_idx_l1_active_minus1; i++)
        {
            ...
            {
                my_printf("delta_luma_weight_l1[%d]: %d  (v bits)", i, pwt->delta_luma_weight_l1[i]);
                AddTreeItem(nria_l);
                my_printf("luma_offset_l1[%d]: %d  (v bits)", i, pwt->luma_offset_l1[i]);
                AddTreeItem(nria_l);
...
void CNalParser::h265_debug_slice_header(h265_stream_t* h, HTREEITEM root)
{
    ...
    my_printf_flag("first_slice_segment_in_pic_flag", hrd->first_slice_segment_in_pic_flag);
    AddTreeItem(ihrd);
    if (nal_unit_type >= NAL_UNIT_CODED_SLICE_BLA_W_LP && nal_unit_type <= NAL_UNIT_RESERVED_IRAP_VCL23)
    {
        my_printf_flag("no_output_of_prior_pics_flag", hrd->no_output_of_prior_pics_flag);
        AddTreeItem(ihrd);
    }
    my_printf("slice_pic_parameter_set_id: %d (v bits)", hrd->slice_pic_parameter_set_id);
    AddTreeItem(ihrd);
    if (!hrd->first_slice_segment_in_pic_flag)
    {
        if (pps->dependent_slice_segments_enabled_flag)
        {
            my_printf_flag("dependent_slice_segment_flag", hrd->dependent_slice_segment_flag);
            AddTreeItem(ihrd);
        }
    ...
    if (!hrd->dependent_slice_segment_flag)
    {
        ...
        my_printf("slice_type: %d (%s) (v bits)", hrd->slice_type, slice_type_name);
        AddTreeItem(dssf);
        if (pps->output_flag_present_flag)
        {
            my_printf_flag("pic_output_flag", hrd->pic_output_flag);
            AddTreeItem(dssf);
        }
        if (sps->separate_colour_plane_flag == 1)
        {
            my_printf("colour_plane_id: %d  (2 bits)", hrd->colour_plane_id);
            AddTreeItem(dssf);
        }
        ...
        {
            my_printf("slice_pic_order_cnt_lsb: %d  (%d bits)", hrd->slice_pic_order_cnt_lsb, hrd->slice_pic_order_cnt_lsb_bytes);
            AddTreeItem(dssf);
            my_printf_flag("short_term_ref_pic_set_sps_flag", hrd->short_term_ref_pic_set_sps_flag);
            AddTreeItem(dssf);
            ...
            if (sps->long_term_ref_pics_present_flag)
            {
                ...
                {
                    my_printf("num_long_term_sps: %d  (v bits)", hrd->num_long_term_sps);
                    AddTreeItem(dssf);
                }
                my_printf("num_long_term_pics: %d  (v bits)", hrd->num_long_term_pics);
                AddTreeItem(dssf);
                for (int i = 0; i < (int)hrd->lt_idx_sps.size(); i++)
                {
                    if (i < hrd->num_long_term_sps)
                    {
                        ...
                        {
                            my_printf("lt_idx_sps[%d]: %d  (v bits)", i, hrd->lt_idx_sps[i]);
                            AddTreeItem(dssf);
                        }
                    }
                    else
                    {
                        my_printf("poc_lsb_lt[%d]: %d  (v bits)", i, hrd->poc_lsb_lt[i]);
                        AddTreeItem(dssf);
                        my_printf_flag2("used_by_curr_pic_lt_flag", i, hrd->used_by_curr_pic_lt_flag[i]);
                        AddTreeItem(dssf);
                    }
                    my_printf_flag2("delta_poc_msb_present_flag", i, hrd->delta_poc_msb_present_flag[i]);
                    AddTreeItem(dssf);
            ...
            {
                my_printf_flag("slice_temporal_mvp_enabled_flag", hrd->slice_temporal_mvp_enabled_flag);
                AddTreeItem(dssf);
            }
        }
        ...
        {
            my_printf_flag("slice_sao_luma_flag", hrd->slice_sao_luma_flag);
            AddTreeItem(dssf);
            my_printf_flag("slice_sao_chroma_flag", hrd->slice_sao_chroma_flag);
            AddTreeItem(dssf);
        }
        if (hrd->slice_type == H265_SH_SLICE_TYPE_P || hrd->slice_type == H265_SH_SLICE_TYPE_B)
        {
            ...
            {
                my_printf("num_ref_idx_l0_active_minus1: %d  (v bits)", hrd->num_ref_idx_l0_active_minus1);
                AddTreeItem(dssf);
                if (hrd->slice_type == H265_SH_SLICE_TYPE_B)
                {
                    my_printf("num_ref_idx_l1_active_minus1: %d  (v bits)", hrd->num_ref_idx_l1_active_minus1);
                    AddTreeItem(dssf);
                }
            }
            ...
            if (hrd->slice_type == H265_SH_SLICE_TYPE_B)
            {
                my_printf_flag("mvd_l1_zero_flag", hrd->mvd_l1_zero_flag);
                AddTreeItem(dssf);
            }
            if (pps->cabac_init_present_flag)
            {
                my_printf_flag("cabac_init_flag", hrd->cabac_init_flag);
                AddTreeItem(dssf);
            }
            if (hrd->slice_temporal_mvp_enabled_flag)
            {
                if (hrd->slice_type == H265_SH_SLICE_TYPE_B)
                {
                    my_printf_flag("collocated_from_l0_flag", hrd->collocated_from_l0_flag);
                    AddTreeItem(dssf);
                }
                ...
                {
                    my_printf("collocated_ref_idx: %d  (v bits)", hrd->collocated_ref_idx);
                    AddTreeItem(dssf);
                }
            }
            ...
            my_printf("five_minus_max_num_merge_cand: %d  (v bits)", hrd->five_minus_max_num_merge_cand);
            AddTreeItem(dssf);
        }
        my_printf("slice_qp_delta: %d  (v bits)", hrd->slice_qp_delta);
        AddTreeItem(dssf);
        if (pps->pps_slice_chroma_qp_offsets_present_flag)
        {
            my_printf("slice_cb_qp_offset: %d  (v bits)", hrd->slice_cb_qp_offset);
            AddTreeItem(dssf);
            my_printf("slice_cr_qp_offset: %d  (v bits)", hrd->slice_cr_qp_offset);
            AddTreeItem(dssf);
        }
        if (pps->pps_range_extension.chroma_qp_offset_list_enabled_flag)
        {
            my_printf_flag("cu_chroma_qp_offset_enabled_flag", hrd->cu_chroma_qp_offset_enabled_flag);
            AddTreeItem(dssf);
        }
        if (pps->deblocking_filter_override_enabled_flag)
        {
            my_printf_flag("deblocking_filter_override_flag", hrd->deblocking_filter_override_flag);
            AddTreeItem(dssf);
        }
        if (hrd->deblocking_filter_override_flag)
        {
            ...
            {
                my_printf("slice_beta_offset_div2: %d  (v bits)", hrd->slice_beta_offset_div2);
                AddTreeItem(dfof);
                my_printf("slice_tc_offset_div2: %d  (v bits)", hrd->slice_tc_offset_div2);
                AddTreeItem(dfof);
            }
        }
    ...
    if (pps->tiles_enabled_flag || pps->entropy_coding_sync_enabled_flag)
    {
        ...
        {
            my_printf("offset_len_minus1: %d (v bits)", hrd->offset_len_minus1);
            AddTreeItem(inepo);
...
void CNalParser::h265_debug_nal_t(h265_stream_t* h, h265_nal_t* nal)
{
    ...
    my_printf("forbidden_zero_bit: %d (1 bit)", nal->forbidden_zero_bit);
    AddTreeItem(subroot);
    my_printf("nal_unit_type: %d (%s) (6 bits)", nal->nal_unit_type, nal_unit_type_name);
    AddTreeItem(subroot);
    my_printf("nuh_layer_id: %d (6 bits)", nal->nuh_layer_id);
    AddTreeItem(subroot);
    my_printf("nuh_temporal_id_plus1: %d (3 bits)", nal->nuh_temporal_id_plus1);
    AddTreeItem(subroot);
