...
bool nv12_to_bgra(unsigned char* rgba, unsigned char alpha, unsigned char const* nv12, int width, int height)
{
    return decode_yuv<NV12toBGRA>(rgba, nv12, width, height, alpha);
}
